...
@Keep
@EXClassNullAway
public class DataGimbalSaveUserParams extends DataBase implements DJIDataSyncListener {
    private static DataGimbalSaveUserParams instance = null;
    ...
    public static synchronized DataGimbalSaveUserParams getInstance() {
        ...
        synchronized (DataGimbalSaveUserParams.class) {
            ...
            dataGimbalSaveUserParams = instance;
        }
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdGimbal.CmdIdType.SaveUserParams.value();
        start(pack, callBack);
    }
}

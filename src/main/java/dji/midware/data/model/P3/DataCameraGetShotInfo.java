...
@Keep
@EXClassNullAway
public class DataCameraGetShotInfo extends DJICameraDataBase implements DJIDataSyncListener {
    ...
    public String getName() {
        return BytesUtil.getStringUTF8Offset(this._recData, 6, 31);
    }
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdCamera.CmdIdType.GetShotInfo.value();
        start(pack, callBack);
    }
}

...
@Keep
@EXClassNullAway
public class DataOsdSetSdrForceBoost extends DataBase implements DJIDataSyncListener {
    private static DataOsdSetSdrForceBoost instance = null;
    ...
    public static synchronized DataOsdSetSdrForceBoost getInstance() {
        ...
        synchronized (DataOsdSetSdrForceBoost.class) {
            ...
            dataOsdSetSdrForceBoost = instance;
        }
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdOsd.CmdIdType.SetSDRForceBoost.value();
        start(pack, callBack);
    }
}

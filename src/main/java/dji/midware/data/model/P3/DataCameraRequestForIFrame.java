...
@Keep
@EXClassNullAway
public class DataCameraRequestForIFrame extends DataBase implements DJIDataSyncListener {
    private static DataCameraRequestForIFrame instance = null;
    ...
    public static synchronized DataCameraRequestForIFrame getInstance() {
        ...
        synchronized (DataCameraRequestForIFrame.class) {
            ...
            dataCameraRequestForIFrame = instance;
        }
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdCamera.CmdIdType.RequestIFrame.value();
        start(pack, callBack);
    }

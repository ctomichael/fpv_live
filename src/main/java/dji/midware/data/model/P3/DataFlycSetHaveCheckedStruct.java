...
@Keep
@EXClassNullAway
public class DataFlycSetHaveCheckedStruct extends DataBase implements DJIDataSyncListener {
    private static DataFlycSetHaveCheckedStruct instance = null;
    ...
    public static synchronized DataFlycSetHaveCheckedStruct getInstance() {
        ...
        synchronized (DataFlycSetHaveCheckedStruct.class) {
            ...
            dataFlycSetHaveCheckedStruct = instance;
        }
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdFlyc.CmdIdType.SetHaveCheckedStruct.value();

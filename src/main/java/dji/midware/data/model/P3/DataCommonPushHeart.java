...
@Keep
@EXClassNullAway
public class DataCommonPushHeart extends DataBase implements DJIDataSyncListener {
    private static final String TAG = "DataCommonPushHeart";
    protected DeviceType receiver;

    public DataCommonPushHeart setReceiver(DeviceType device) {
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdCommon.CmdIdType.HeartBeat.value();
        start(pack, callBack);
    }
}

...
@Keep
@EXClassNullAway
public class DataWifiGetPassword extends DataBase implements DJIDataSyncListener {
    ...
    public DataWifiGetPassword setFromLongan(boolean isFromLongan2) {
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdWifi.CmdIdType.GetPassword.value();

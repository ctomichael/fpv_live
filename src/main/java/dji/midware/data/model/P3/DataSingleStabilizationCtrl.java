...
@Keep
@EXClassNullAway
public class DataSingleStabilizationCtrl extends DataBase implements DJIDataSyncListener {
    private CtrlState mCtrlCmd = CtrlState.OTHER;

    public DataSingleStabilizationCtrl setCtrlCmd(boolean start) {
        if (start) {
    ...
    public void doPack() {
        ...
        this._sendData[0] = (byte) this.mCtrlCmd.value();
    }
    ...
    public enum CtrlState {
        ...
        public static CtrlState find(int b) {
            CtrlState result = OTHER;

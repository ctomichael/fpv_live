...
@Keep
@EXClassNullAway
public class DataCameraGetVideoContrastEnhance extends DataBase implements DJIDataSyncListener {
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdCamera.CmdIdType.GetVideoContrastEnhance.value();
        start(pack, callBack);
    }

...
@Keep
@EXClassNullAway
public class DataOnBoardSdkSetPowerState extends DataBase implements DJIDataSyncListener {
    private boolean powerOn = true;

    public DataOnBoardSdkSetPowerState setPowerState(boolean switchOn) {

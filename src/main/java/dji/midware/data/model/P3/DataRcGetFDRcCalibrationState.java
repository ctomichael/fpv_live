...
@Keep
@EXClassNullAway
public class DataRcGetFDRcCalibrationState extends DataBase implements DJIDataSyncListener {
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        } else if (DJIComponentManager.getInstance().isRcRM500()) {
        ...
        pack.cmdId = CmdIdRc.CmdIdType.GetFDRcCalibrationStatue.value();

...
public class DataOnBoardSdkSetVisionEnabledState extends DataBase implements DJIDataSyncListener {
    private boolean powerOn = true;

    public DataOnBoardSdkSetVisionEnabledState setEnabledState(boolean switchOn) {

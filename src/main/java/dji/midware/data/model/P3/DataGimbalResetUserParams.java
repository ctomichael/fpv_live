...
@Keep
@EXClassNullAway
public class DataGimbalResetUserParams extends DataBase implements DJIDataSyncListener {
    private static DataGimbalResetUserParams instance = null;
    ...
    public static synchronized DataGimbalResetUserParams getInstance() {
        ...
        synchronized (DataGimbalResetUserParams.class) {
            if (instance == null) {
                instance = new DataGimbalResetUserParams();
            }
            dataGimbalResetUserParams = instance;
        }
    ...
    public void start(DJIDataCallBack callBack) {
        ...
        pack.cmdId = CmdIdGimbal.CmdIdType.ResetUserParams.value();
        start(pack, callBack);
    }
}

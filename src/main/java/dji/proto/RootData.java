...
public final class RootData extends Message<RootData, Builder> {
    ...
    public static final Integer DEFAULT_DECRYPT_LEN = 0;
    ...
    public final Integer decrypt_len;
    @WireField(adapter = "dji.proto.RootData$EncryptionType#ADAPTER", tag = 2)
    public final EncryptionType encryption;
    @WireField(adapter = "dji.proto.RootData$PlatformType#ADAPTER", tag = 3)
    ...
    public RootData(Integer version2, EncryptionType encryption2, PlatformType platform2, String app_key2, Integer app_version2, Integer decrypt_len2, ByteString content2, String cmd2, Integer timestamp2, String signature2) {
        this(version2, encryption2, platform2, app_key2, app_version2, decrypt_len2, content2, cmd2, timestamp2, signature2, ByteString.EMPTY);
    }

    public RootData(Integer version2, EncryptionType encryption2, PlatformType platform2, String app_key2, Integer app_version2, Integer decrypt_len2, ByteString content2, String cmd2, Integer timestamp2, String signature2, ByteString unknownFields) {
    ...
    public Builder newBuilder() {
        ...
        builder.decrypt_len = this.decrypt_len;
    ...
    public boolean equals(Object other) {
        ...
        if (!unknownFields().equals(o.unknownFields()) || !Internal.equals(this.version, o.version) || !Internal.equals(this.encryption, o.encryption) || !Internal.equals(this.platform, o.platform) || !Internal.equals(this.app_key, o.app_key) || !Internal.equals(this.app_version, o.app_version) || !Internal.equals(this.decrypt_len, o.decrypt_len) || !Internal.equals(this.content, o.content) || !Internal.equals(this.cmd, o.cmd) || !Internal.equals(this.timestamp, o.timestamp) || !Internal.equals(this.signature, o.signature)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int i13 = (i12 + i4) * 37;
        if (this.decrypt_len != null) {
            i5 = this.decrypt_len.hashCode();
        } else {
            i5 = 0;
        }
        int i14 = (i13 + i5) * 37;
    ...
    public String toString() {
        ...
        if (this.decrypt_len != null) {
            builder.append(", decrypt_len=").append(this.decrypt_len);
        }
        if (this.content != null) {
    ...
    public static final class Builder extends Message.Builder<RootData, Builder> {
        ...
        public Builder decrypt_len(Integer decrypt_len2) {
            this.decrypt_len = decrypt_len2;
            return this;
        }
        ...
        public RootData build() {
            return new RootData(this.version, this.encryption, this.platform, this.app_key, this.app_version, this.decrypt_len, this.content, this.cmd, this.timestamp, this.signature, super.buildUnknownFields());
        }
    }
    ...
    private static final class ProtoAdapter_RootData extends ProtoAdapter<RootData> {
        ...
        public int encodedSize(RootData value) {
            ...
            int i13 = i12 + i4;
            if (value.decrypt_len != null) {
                i5 = ProtoAdapter.INT32.encodedSizeWithTag(6, value.decrypt_len);
            } else {
                i5 = 0;
            }
            int i14 = i13 + i5;
        ...
        public void encode(ProtoWriter writer, RootData value) throws IOException {
            ...
            if (value.decrypt_len != null) {
                ProtoAdapter.INT32.encodeWithTag(writer, 6, value.decrypt_len);
            }
            if (value.content != null) {
                ...
                if (tag != -1) {
                    switch (tag) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            builder.decrypt_len(ProtoAdapter.INT32.decode(reader));
                            break;
                        case 7:

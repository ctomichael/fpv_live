...
final /* synthetic */ class BatteryDiagnosticsHandler$$Lambda$1 implements Consumer {
    private final Set arg$1;

    private BatteryDiagnosticsHandler$$Lambda$1(Set set) {
        this.arg$1 = set;
    }

    static Consumer get$Lambda(Set set) {
        return new BatteryDiagnosticsHandler$$Lambda$1(set);
    }

...
final /* synthetic */ class CameraDiagnosticsHandler$$Lambda$2 implements Consumer {
    private final Set arg$1;

    private CameraDiagnosticsHandler$$Lambda$2(Set set) {
        this.arg$1 = set;
    }

    static Consumer get$Lambda(Set set) {
        return new CameraDiagnosticsHandler$$Lambda$2(set);
    }

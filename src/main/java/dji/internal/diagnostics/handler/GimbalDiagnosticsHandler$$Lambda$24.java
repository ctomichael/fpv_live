...
final /* synthetic */ class GimbalDiagnosticsHandler$$Lambda$24 implements Consumer {
    private final Set arg$1;

    private GimbalDiagnosticsHandler$$Lambda$24(Set set) {
        this.arg$1 = set;
    }

    static Consumer get$Lambda(Set set) {
        return new GimbalDiagnosticsHandler$$Lambda$24(set);
    }

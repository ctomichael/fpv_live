...
final /* synthetic */ class ProductDiagnosticsHandler$$Lambda$3 implements Consumer {
    private final Set arg$1;

    private ProductDiagnosticsHandler$$Lambda$3(Set set) {
        this.arg$1 = set;
    }

    static Consumer get$Lambda(Set set) {
        return new ProductDiagnosticsHandler$$Lambda$3(set);
    }

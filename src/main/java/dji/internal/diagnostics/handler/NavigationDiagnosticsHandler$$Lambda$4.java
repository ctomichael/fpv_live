...
final /* synthetic */ class NavigationDiagnosticsHandler$$Lambda$4 implements Consumer {
    private final Set arg$1;

    private NavigationDiagnosticsHandler$$Lambda$4(Set set) {
        this.arg$1 = set;
    }

    static Consumer get$Lambda(Set set) {
        return new NavigationDiagnosticsHandler$$Lambda$4(set);
    }

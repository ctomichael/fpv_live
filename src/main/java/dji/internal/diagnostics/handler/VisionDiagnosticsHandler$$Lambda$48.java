...
final /* synthetic */ class VisionDiagnosticsHandler$$Lambda$48 implements Consumer {
    private final Set arg$1;

    private VisionDiagnosticsHandler$$Lambda$48(Set set) {
        this.arg$1 = set;
    }

    static Consumer get$Lambda(Set set) {
        return new VisionDiagnosticsHandler$$Lambda$48(set);
    }

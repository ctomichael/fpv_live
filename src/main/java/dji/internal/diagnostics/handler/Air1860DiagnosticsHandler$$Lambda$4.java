...
final /* synthetic */ class Air1860DiagnosticsHandler$$Lambda$4 implements Predicate {
    private final DataOsdGetPushWirelessState.SdrWirelessState arg$1;

    private Air1860DiagnosticsHandler$$Lambda$4(DataOsdGetPushWirelessState.SdrWirelessState sdrWirelessState) {
        this.arg$1 = sdrWirelessState;
    }

    static Predicate get$Lambda(DataOsdGetPushWirelessState.SdrWirelessState sdrWirelessState) {
        return new Air1860DiagnosticsHandler$$Lambda$4(sdrWirelessState);
    }

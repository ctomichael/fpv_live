...
public enum DJIFileResolution {
    ...
    Size_640_360p(46, OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 360),
    ...
    private DJIFileResolution(int _data) {
        this.data = _data;
    }

    private DJIFileResolution(int _data, int width2, int height2) {
        this.data = _data;
        this.width = width2;
        this.height = height2;
    }
    ...
    public static DJIFileResolution find(int b) {
        DJIFileResolution result = UNDEFINED;
        int i = 0;
        while (true) {
            if (i >= values().length) {
                break;
    ...
    public static DJIFileResolution find(String ext) {
        DJIFileResolution result = UNDEFINED;
    ...
    public boolean isLowerThan(DJIFileResolution resolution) {

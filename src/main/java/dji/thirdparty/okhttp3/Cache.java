...
import dji.thirdparty.okhttp3.internal.cache.CacheRequest;
import dji.thirdparty.okhttp3.internal.cache.CacheStrategy;
import dji.thirdparty.okhttp3.internal.cache.DiskLruCache;
import dji.thirdparty.okhttp3.internal.cache.InternalCache;
import dji.thirdparty.okhttp3.internal.http.HttpHeaders;
import dji.thirdparty.okhttp3.internal.http.HttpMethod;
...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File directory, long maxSize, FileSystem fileSystem) {
        this.internalCache = new InternalCache() {
            /* class dji.thirdparty.okhttp3.Cache.AnonymousClass1 */
    ...
    public Iterator<String> urls() throws IOException {
        return new Iterator<String>() {
            /* class dji.thirdparty.okhttp3.Cache.AnonymousClass2 */
            boolean canRemove;
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(final DiskLruCache.Editor editor2) {
            ...
            this.body = new ForwardingSink(this.cacheOut, Cache.this) {
                /* class dji.thirdparty.okhttp3.Cache.CacheRequestImpl.AnonymousClass1 */
        ...
        public void abort() {
            /*
                r3 = this;
                dji.thirdparty.okhttp3.Cache r1 = dji.thirdparty.okhttp3.Cache.this
                monitor-enter(r1)
            ...
            L_0x0009:
                ...
                dji.thirdparty.okhttp3.Cache r0 = dji.thirdparty.okhttp3.Cache.this     // Catch:{ all -> 0x0022 }
                ...
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Editor r0 = r3.editor     // Catch:{ IOException -> 0x0020 }
            ...
            L_0x0022:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.okhttp3.Cache.CacheRequestImpl.abort():void");
        }
    ...
    private static class CacheResponseBody extends ResponseBody {
        ...
        CacheResponseBody(final DiskLruCache.Snapshot snapshot2, String contentType2, String contentLength2) {
            ...
            this.bodySource = Okio.buffer(new ForwardingSource(snapshot2.getSource(1)) {
                /* class dji.thirdparty.okhttp3.Cache.CacheResponseBody.AnonymousClass1 */

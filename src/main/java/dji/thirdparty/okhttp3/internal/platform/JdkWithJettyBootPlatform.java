package dji.thirdparty.okhttp3.internal.platform;
...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(negoClass.getMethod("put", SSLSocket.class, providerClass), negoClass.getMethod("get", SSLSocket.class), negoClass.getMethod(ErrorPopModel.ACTION_REMOVE, SSLSocket.class), clientProviderClass2, serverProviderClass2);

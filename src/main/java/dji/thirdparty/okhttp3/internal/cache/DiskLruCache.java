...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* class dji.thirdparty.okhttp3.internal.cache.DiskLruCache.AnonymousClass1 */
        ...
        public void run() {
            /*
                ...
                r3 = 0
                r2 = 1
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache r4 = dji.thirdparty.okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r4)
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache r5 = dji.thirdparty.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x002f }
                boolean r5 = r5.initialized     // Catch:{ all -> 0x002f }
                if (r5 != 0) goto L_0x0014
            L_0x000b:
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache r3 = dji.thirdparty.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x002f }
            ...
            L_0x0014:
                ...
                goto L_0x000b
            L_0x0016:
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache r2 = dji.thirdparty.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0032 }
                r2.trimToSize()     // Catch:{ IOException -> 0x0032 }
            L_0x001b:
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache r2 = dji.thirdparty.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0039 }
            ...
            L_0x0032:
                r1 = move-exception
                dji.thirdparty.okhttp3.internal.cache.DiskLruCache r2 = dji.thirdparty.okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x002f }
                r3 = 1
            ...
            L_0x0039:
                ...
                okio.BufferedSink r3 = okio.Okio.buffer(r3)     // Catch:{ all -> 0x002f }
                r2.journalWriter = r3     // Catch:{ all -> 0x002f }
                goto L_0x002d
            */
            throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.okhttp3.internal.cache.DiskLruCache.AnonymousClass1.run():void");
        }
    };
    boolean closed;
    ...
    private void readJournal() throws IOException {
        ...
        try {
            ...
            if (!MAGIC.equals(magic) || !"1".equals(version) || !Integer.toString(this.appVersion).equals(appVersionString) || !Integer.toString(this.valueCount).equals(valueCountString) || !"".equals(blank)) {
                throw new IOException("unexpected journal header: [" + magic + ", " + version + ", " + valueCountString + ", " + blank + IMemberProtocol.STRING_SEPERATOR_RIGHT);
            }
            lineCount = 0;
            while (true) {
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            /* class dji.thirdparty.okhttp3.internal.cache.DiskLruCache.AnonymousClass2 */
            static final /* synthetic */ boolean $assertionsDisabled = (!DiskLruCache.class.desiredAssertionStatus());
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized dji.thirdparty.okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        /*
            r4 = this;
            r0 = 0
            monitor-enter(r4)
            ...
            java.util.LinkedHashMap<java.lang.String, dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Entry> r2 = r4.lruEntries     // Catch:{ all -> 0x0039 }
            java.lang.Object r1 = r2.get(r5)     // Catch:{ all -> 0x0039 }
            dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Entry r1 = (dji.thirdparty.okhttp3.internal.cache.DiskLruCache.Entry) r1     // Catch:{ all -> 0x0039 }
            r2 = -1
        ...
        L_0x0023:
            ...
            dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Editor r2 = r1.currentEditor     // Catch:{ all -> 0x0039 }
        ...
        L_0x003c:
            ...
            dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Entry r1 = new dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Entry     // Catch:{ all -> 0x0039 }
            r1.<init>(r5)     // Catch:{ all -> 0x0039 }
            java.util.LinkedHashMap<java.lang.String, dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Entry> r2 = r4.lruEntries     // Catch:{ all -> 0x0039 }
            r2.put(r5, r1)     // Catch:{ all -> 0x0039 }
        L_0x0069:
            dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Editor r0 = new dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Editor     // Catch:{ all -> 0x0039 }
            r0.<init>(r1)     // Catch:{ all -> 0x0039 }
            r1.currentEditor = r0     // Catch:{ all -> 0x0039 }
            goto L_0x0021
        */
        throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.okhttp3.internal.cache.DiskLruCache.edit(java.lang.String, long):dji.thirdparty.okhttp3.internal.cache.DiskLruCache$Editor");
    }
    ...
    public synchronized Iterator<Snapshot> snapshots() throws IOException {
        ...
        return new Iterator<Snapshot>() {
            /* class dji.thirdparty.okhttp3.internal.cache.DiskLruCache.AnonymousClass3 */
                ...
                if (this.done) {
                    ...
                    try {
                        blackhole = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
                            /* class dji.thirdparty.okhttp3.internal.cache.DiskLruCache.Editor.AnonymousClass1 */

...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new Comparator<String>() {
        /* class dji.thirdparty.okhttp3.internal.Util.AnonymousClass1 */
    ...
    public static ThreadFactory threadFactory(final String name, final boolean daemon) {
        return new ThreadFactory() {
            /* class dji.thirdparty.okhttp3.internal.Util.AnonymousClass2 */
    ...
    public static String hostHeader(HttpUrl url, boolean includeDefaultPort) {
        ...
        if (url.host().contains(":")) {
            host = IMemberProtocol.STRING_SEPERATOR_LEFT + url.host() + IMemberProtocol.STRING_SEPERATOR_RIGHT;
        } else {
            host = url.host();
        }
    ...
    public static String canonicalizeHost(String host) {
        ...
        if (host.contains(":")) {
            if (!host.startsWith(IMemberProtocol.STRING_SEPERATOR_LEFT) || !host.endsWith(IMemberProtocol.STRING_SEPERATOR_RIGHT)) {

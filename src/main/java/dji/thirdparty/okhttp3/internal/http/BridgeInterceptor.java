...
import dji.thirdparty.okhttp3.CookieJar;
...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (userRequest.header(DJISDKCacheKeys.CONNECTION) == null) {
            requestBuilder.header(DJISDKCacheKeys.CONNECTION, "Keep-Alive");
        }

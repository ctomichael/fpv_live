...
public class FinalDb {
    ...
    private FinalDb(DaoConfig config2) {
    ...
    private SQLiteDatabase generateDb(DaoConfig config2) {
        if (config2 == null) {
            ...
            return new SqliteDbHelper(config2.getContext().getApplicationContext(), config2.getDbName(), config2.getDbVersion(), config2.getDbUpdateListener()).getWritableDatabase();
        }
    }
    ...
    public void saveManyStep(Object entity) {
        if (this.statement != null) {
            ...
            this.statement.bindAllArgsAsStrings(SqlBuilder.getSaveKeyValueArrayByEntity(this.tableInfo, entity));
    ...
    public void saveManyStepByWhere(Object entity, String value) {
        if (this.statementWhere != null) {
            ...
            this.statementWhere.bindAllArgsAsStrings(SqlBuilder.getSaveKeyValueArrayByEntityWithId(this.tableInfo, entity, this.statementKey, value));
    ...
    private void exeSqlInfo(SqlInfo sqlInfo) {
        ...
        Log.e(TAG, "exec error:sqlInfo is null");
    }
    ...
    public void exeSql(String sql) {
        ...
        Log.e(TAG, "exec error:sql is null");
    }
    ...
    private boolean tableIsExist(TableInfo table) {
        ...
        try {
            ...
            debugSql(sql);
            Cursor cursor2 = this.db.rawQuery(sql, null);
        ...
        if (!dbf.exists()) {
            try {
                if (dbf.createNewFile()) {
                    db2 = SQLiteDatabase.openDatabase(dbf.getPath(), null, 16, null);
                }
    ...
    class SqliteDbHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            SQLiteDatabase unused = FinalDb.this.db = db;
            FinalDb.this.dropDb();
        }

        public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            if (this.mDbUpdateListener != null) {
                this.mDbUpdateListener.onDowngrade(db, oldVersion, newVersion);
                return;
            }
            SQLiteDatabase unused = FinalDb.this.db = db;
            FinalDb.this.dropDb();

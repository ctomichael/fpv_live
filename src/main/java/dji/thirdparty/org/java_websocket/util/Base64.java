...
public class Base64 {
    ...
    public static java.lang.Object decodeToObject(java.lang.String r9, int r10, final java.lang.ClassLoader r11) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        L_0x001e:
            return r3
        L_0x001f:
            dji.thirdparty.org.java_websocket.util.Base64$1 r6 = new dji.thirdparty.org.java_websocket.util.Base64$1     // Catch:{ IOException -> 0x0040, ClassNotFoundException -> 0x003d, all -> 0x003a }
        ...
        L_0x0040:
            ...
            goto L_0x0027
        */
        throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.org.java_websocket.util.Base64.decodeToObject(java.lang.String, int, java.lang.ClassLoader):java.lang.Object");
    }
    ...
    public static class InputStream extends FilterInputStream {
        ...
        public InputStream(java.io.InputStream in2) {
            this(in2, 0);
        }

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public InputStream(java.io.InputStream in2, int options2) {
            super(in2);
            boolean z = true;
            ...
            if (this.position < 0) {
                if (this.encode) {
                    ...
                    while (i2 < 4) {
                        ...
                        } while (this.decodabet[b & CertificateBody.profileType] <= -5);
                        if (b < 0) {
                            break;
                        }
                        b4[i2] = (byte) b;
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int theByte) throws IOException {
            ...
            } else if (this.decodabet[theByte & CertificateBody.profileType] > -5) {

...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    public FlowableCombineLatest(Publisher[] publisherArr, Function function, int bufferSize2, boolean delayErrors2) {
    ...
    public FlowableCombineLatest(Iterable iterable2, Function function, int bufferSize2, boolean delayErrors2) {
        this.array = null;
    ...
    public void subscribeActual(Subscriber<? super R> s) {
        ...
        if (n == 0) {
            ...
            new FlowableMap(a[0], new Function<T, R>() {
                /* class dji.thirdparty.io.reactivex.internal.operators.flowable.FlowableCombineLatest.AnonymousClass1 */
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        public void innerComplete(int r4) {
            ...
            L_0x001d:
                ...
                goto L_0x0011
            */
            throw new UnsupportedOperationException("Method not decompiled: dji.thirdparty.io.reactivex.internal.operators.flowable.FlowableCombineLatest.CombineLatestCoordinator.innerComplete(int):void");
        }
    ...
    static final class CombineLatestInnerSubscriber<T> extends AtomicReference<Subscription> implements Subscriber<T> {

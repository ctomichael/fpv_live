...
@EXClassNullAway
public enum OcuSyncSecondaryVideoFormat {
    ...
    private OcuSyncSecondaryVideoFormat(int value2) {
        this.value = value2;
    }
    ...
    public static OcuSyncSecondaryVideoFormat find(int value2) {
        OcuSyncSecondaryVideoFormat result = UNKNOWN;

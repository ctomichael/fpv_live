...
@EXClassNullAway
public class RcOnly extends AbstractStrategy {
    ...
    public void doNext(Context context, DJIUpDeviceType device1, DJIUpDeviceType device2) {
        ...
        this.collector1.setCollectorListener(new UpCollectorListener() {
            /* class dji.dbox.upgrade.strategy.RcOnly.AnonymousClass1 */

            public void onStrategyCollectListOver() {
                DJIUpStatusHelper.setIsNeedLockGetted(RcOnly.this.collector1.getStatus().isNeedLockGetted());
                DJIUpStatusHelper.setIsNeedLock(RcOnly.this.collector1.getStatus().isNeedLock());
                RcOnly.this.upCollectorListener.onStrategyCollectListOver();
            }

            public void onStrategyCollectVersionOver() {
                RcOnly.this.upCollectorListener.onStrategyCollectVersionOver();
            }
        });

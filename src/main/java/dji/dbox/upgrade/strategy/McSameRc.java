...
@EXClassNullAway
public class McSameRc extends AbstractStrategy {
    ...
    public void doNext(Context context, DJIUpDeviceType device1, DJIUpDeviceType device2) {
        ...
        this.collector1.setCollectorListener(new UpCollectorListener() {
            /* class dji.dbox.upgrade.strategy.McSameRc.AnonymousClass1 */

            public void onStrategyCollectListOver() {
                DJIUpStatusHelper.setIsNeedLockGetted(McSameRc.this.collector1.getStatus().isNeedLockGetted());
                DJIUpStatusHelper.setIsNeedLock(McSameRc.this.collector1.getStatus().isNeedLock());
                McSameRc.this.upCollectorListener.onStrategyCollectListOver();
            }

            public void onStrategyCollectVersionOver() {
                McSameRc.this.upCollectorListener.onStrategyCollectVersionOver();
            }
        });

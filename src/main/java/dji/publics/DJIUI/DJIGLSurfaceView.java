...
public class DJIGLSurfaceView extends GLSurfaceView implements DJIViewShowInterface, DJIViewAnimShowInterface {
    private AnimatorListenerAdapter animGoListener = new AnimatorListenerAdapter() {
        /* class dji.publics.DJIUI.DJIGLSurfaceView.AnonymousClass1 */
    ...
    private AnimatorListenerAdapter animShowListener = new AnimatorListenerAdapter() {
        /* class dji.publics.DJIUI.DJIGLSurfaceView.AnonymousClass2 */

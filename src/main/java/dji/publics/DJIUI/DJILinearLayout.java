...
public class DJILinearLayout extends LinearLayout implements DJIViewShowInterface, DJIViewAnimShowInterface {
    private AnimatorListenerAdapter animGoListener = new AnimatorListenerAdapter() {
        /* class dji.publics.DJIUI.DJILinearLayout.AnonymousClass1 */

        public void onAnimationEnd(Animator animation) {
            DJILinearLayout.this.go();
            DJILinearLayout.this.animate().setListener(null);
        }
    };
    private AnimatorListenerAdapter animShowListener = new AnimatorListenerAdapter() {
        /* class dji.publics.DJIUI.DJILinearLayout.AnonymousClass2 */

        public void onAnimationStart(Animator animation) {
            DJILinearLayout.this.show();
        }
    ...
    public DJILinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DJILinearLayout(Context context, AttributeSet attrs, int defStyle) {

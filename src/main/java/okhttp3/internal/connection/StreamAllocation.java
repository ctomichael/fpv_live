...
public final class StreamAllocation {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:88:0x0191, code lost:
        if (r2.isMultiplexed() == false) goto L_0x01a7;
     */
    ...
    private okhttp3.internal.connection.RealConnection findConnection(int r23, int r24, int r25, int r26, boolean r27) throws java.io.IOException {
        ...
        L_0x0070:
            monitor-exit(r4)     // Catch:{ all -> 0x0018 }
            okhttp3.internal.Util.closeQuietly(r21)
        ...
        L_0x00c6:
            ...
            monitor-enter(r4)
            r0 = r22
            boolean r3 = r0.canceled     // Catch:{ all -> 0x00da }
            if (r3 == 0) goto L_0x00dd
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x00da }
            java.lang.String r5 = "Canceled"
            r3.<init>(r5)     // Catch:{ all -> 0x00da }
            throw r3     // Catch:{ all -> 0x00da }
        L_0x00da:
            r3 = move-exception
        L_0x00db:
        ...
        L_0x00dd:
            ...
            r0 = r22
            okhttp3.internal.connection.RouteSelector$Selection r3 = r0.routeSelection     // Catch:{ all -> 0x00da }
            java.util.List r17 = r3.getAll()     // Catch:{ all -> 0x00da }
            r11 = 0
            int r19 = r17.size()     // Catch:{ all -> 0x00da }
        L_0x00ec:
            r0 = r19
            if (r11 >= r0) goto L_0x01c3
            r0 = r17
            java.lang.Object r16 = r0.get(r11)     // Catch:{ all -> 0x00da }
            okhttp3.Route r16 = (okhttp3.Route) r16     // Catch:{ all -> 0x00da }
            okhttp3.internal.Internal r3 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x00da }
            r0 = r22
            okhttp3.ConnectionPool r5 = r0.connectionPool     // Catch:{ all -> 0x00da }
            r0 = r22
            okhttp3.Address r6 = r0.address     // Catch:{ all -> 0x00da }
            r0 = r22
            r1 = r16
            r3.get(r5, r6, r0, r1)     // Catch:{ all -> 0x00da }
            r0 = r22
            okhttp3.internal.connection.RealConnection r3 = r0.connection     // Catch:{ all -> 0x00da }
            if (r3 == 0) goto L_0x0155
            r10 = 1
            r0 = r22
            okhttp3.internal.connection.RealConnection r2 = r0.connection     // Catch:{ all -> 0x00da }
            r0 = r16
            r1 = r22
            r1.route = r0     // Catch:{ all -> 0x00da }
            r14 = r2
        L_0x011b:
            if (r10 != 0) goto L_0x01c1
            if (r18 != 0) goto L_0x0127
            r0 = r22
            okhttp3.internal.connection.RouteSelector$Selection r3 = r0.routeSelection     // Catch:{ all -> 0x01bd }
            okhttp3.Route r18 = r3.next()     // Catch:{ all -> 0x01bd }
        L_0x0127:
            r0 = r18
            r1 = r22
            r1.route = r0     // Catch:{ all -> 0x01bd }
            r3 = 0
            r0 = r22
            r0.refusedStreamCount = r3     // Catch:{ all -> 0x01bd }
            okhttp3.internal.connection.RealConnection r2 = new okhttp3.internal.connection.RealConnection     // Catch:{ all -> 0x01bd }
            r0 = r22
            okhttp3.ConnectionPool r3 = r0.connectionPool     // Catch:{ all -> 0x01bd }
            r0 = r18
            r2.<init>(r3, r0)     // Catch:{ all -> 0x01bd }
            r3 = 0
            r0 = r22
            r0.acquire(r2, r3)     // Catch:{ all -> 0x00da }
        L_0x0143:
            monitor-exit(r4)     // Catch:{ all -> 0x00da }
        ...
        L_0x0158:
            ...
            r3 = 1
            r0 = r22
            r0.reportedAcquired = r3     // Catch:{ all -> 0x01ba }
            okhttp3.internal.Internal r3 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x01ba }
            r0 = r22
            okhttp3.ConnectionPool r5 = r0.connectionPool     // Catch:{ all -> 0x01ba }
            r3.put(r5, r2)     // Catch:{ all -> 0x01ba }
            boolean r3 = r2.isMultiplexed()     // Catch:{ all -> 0x01ba }
            if (r3 == 0) goto L_0x01a7
            okhttp3.internal.Internal r3 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x01ba }
            r0 = r22
            okhttp3.ConnectionPool r5 = r0.connectionPool     // Catch:{ all -> 0x01ba }
            r0 = r22
            okhttp3.Address r6 = r0.address     // Catch:{ all -> 0x01ba }
            r0 = r22
            java.net.Socket r20 = r3.deduplicate(r5, r6, r0)     // Catch:{ all -> 0x01ba }
            r0 = r22
            okhttp3.internal.connection.RealConnection r2 = r0.connection     // Catch:{ all -> 0x01ba }
        L_0x01a7:

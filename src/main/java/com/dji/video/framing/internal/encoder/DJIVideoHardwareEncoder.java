...
public class DJIVideoHardwareEncoder {
    ...
    private void invokeOnEncodeData(byte[] data, MediaCodec.BufferInfo bufferInfo2, int width2, int height2, boolean isKeyFrame) {
        synchronized (this.listenerList) {
    ...
    private void invokeOnEncodeData(ByteBuffer data, MediaCodec.BufferInfo bufferInfo2, int width2, int height2, boolean isKeyFrame) {
        synchronized (this.listenerList) {
            for (VideoHardwareEncoderListener listener : this.listenerList) {
                if (listener != null) {
    ...
    private void startEncodingHandler() {
        if (this.encoderHandler == null) {
            ...
            this.encoderHandler = new Handler(this.encoderHandlerThread.getLooper()) {
                /* class com.dji.video.framing.internal.encoder.DJIVideoHardwareEncoder.AnonymousClass1 */
                    ...
                    switch (msg.what) {
                        ...
                        case 1:
                            ...
                            new Thread(new Runnable() {
                                /* class com.dji.video.framing.internal.encoder.DJIVideoHardwareEncoder.AnonymousClass1.C00191 */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00d3, code lost:
        android.util.Log.e(com.dji.video.framing.internal.encoder.DJIVideoHardwareEncoder.TAG, "start: create input surface error: \n" + ((android.media.MediaCodec.CodecException) r3).getDiagnosticInfo());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:43:0x00f5, code lost:
        android.util.Log.e(com.dji.video.framing.internal.encoder.DJIVideoHardwareEncoder.TAG, "start: create input surface error", r3);
     */
    ...
    public void start(int r12, int r13, int r14, int r15) {
        ...
        L_0x0010:
            ...
            r2 = 0
            java.lang.String r5 = "video/avc"
            android.media.MediaCodec r5 = android.media.MediaCodec.createEncoderByType(r5)     // Catch:{ Exception -> 0x0085 }
            r11.encoder = r5     // Catch:{ Exception -> 0x0085 }
            android.media.MediaCodec r5 = r11.encoder     // Catch:{ Exception -> 0x0085 }
            android.media.MediaCodecInfo r2 = r5.getCodecInfo()     // Catch:{ Exception -> 0x0085 }
        ...
        L_0x00f5:
            ...
            goto L_0x0064
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dji.video.framing.internal.encoder.DJIVideoHardwareEncoder.start(int, int, int, int):void");
    }
    ...
    public void dequeueDataFromEncoder() throws java.lang.IllegalStateException {
        /*
            ...
            monitor-enter(r4)
            android.media.MediaCodec r3 = r8.encoder     // Catch:{ all -> 0x002f }
            if (r3 == 0) goto L_0x000b
            boolean r3 = r8.isEncoderInited     // Catch:{ all -> 0x002f }
        ...
        L_0x000d:
            r2 = -1
            android.media.MediaCodec r3 = r8.encoder     // Catch:{ Exception -> 0x0032 }
            android.media.MediaCodec$BufferInfo r5 = r8.bufferInfo     // Catch:{ Exception -> 0x0032 }
            r6 = 0
            int r2 = r3.dequeueOutputBuffer(r5, r6)     // Catch:{ Exception -> 0x0032 }
        L_0x0018:
            if (r2 < 0) goto L_0x003d
            java.nio.ByteBuffer[] r3 = r8.outputBuffers     // Catch:{ all -> 0x002f }
            r1 = r3[r2]     // Catch:{ all -> 0x002f }
            android.media.MediaCodec$BufferInfo r3 = r8.bufferInfo     // Catch:{ all -> 0x002f }
            r8.onOutputFrame(r1, r3)     // Catch:{ all -> 0x002f }
            android.media.MediaCodec r3 = r8.encoder     // Catch:{ all -> 0x002f }
            if (r3 == 0) goto L_0x002d
            android.media.MediaCodec r3 = r8.encoder     // Catch:{ all -> 0x002f }
            r5 = 0
            r3.releaseOutputBuffer(r2, r5)     // Catch:{ all -> 0x002f }
        L_0x002d:
            monitor-exit(r4)     // Catch:{ all -> 0x002f }
            goto L_0x000c
        L_0x002f:
        ...
        L_0x0032:
            ...
            android.util.Log.e(r3, r5, r0)     // Catch:{ all -> 0x002f }
            goto L_0x0018
        L_0x003d:
            r3 = -3
            if (r2 != r3) goto L_0x0044
            r8.onOutputBufferChanged()     // Catch:{ all -> 0x002f }
            goto L_0x002d
        L_0x0044:
            r3 = -2
            if (r2 != r3) goto L_0x002d
            r8.onOutputFormatChanged()     // Catch:{ all -> 0x002f }
            goto L_0x002d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dji.video.framing.internal.encoder.DJIVideoHardwareEncoder.dequeueDataFromEncoder():void");
    }
    ...
    private void onOutputFrame(ByteBuffer buffer, MediaCodec.BufferInfo bufferInfo2) {
        ...
        if (data == null || data.length <= 5 || (data[4] & 31) != 7) {
            ...
            if (isKeyfram && !this.listenersWaiting.isEmpty()) {
                synchronized (this.listenersWaiting) {
                    this.listenerList.addAll(this.listenersWaiting);
                    this.listenersWaiting.clear();
                }
            }
            invokeOnEncodeData(buffer, bufferInfo2, this.width, this.height, isKeyfram);
            invokeOnEncodeData(rst, bufferInfo2, this.width, this.height, isKeyfram);
            return;
        }

...
public class DJIWheelVerticalView extends DJIWheelView {
    ...
    public DJIWheelVerticalView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs, DJIWheelAdapter.Orientation.VERTICAL);
        View.inflate(getContext(), R.layout.fpv_widget_wheel_vertical_view, this);
    }
}

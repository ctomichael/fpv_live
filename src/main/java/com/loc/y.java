...
public final class y {
    ...
    static byte[] a(byte[] bArr, Key key) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        Cipher instance = Cipher.getInstance(ad.c(al.a));
        instance.init(1, key);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x0023 A[LOOP:2: B:9:0x0023->B:37:0x0092, LOOP_START, PHI: r1 10  PHI: (r1v1 int) = (r1v0 int), (r1v11 int) binds: [B:8:0x0021, B:37:0x0092] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private static String d(byte[] bArr) {
        ...
        while (true) {
            ...
            stringBuffer.append(a[b2 >>> 2]);
            stringBuffer.append(a[((b2 & 3) << 4) | ((b3 & 240) >>> 4)]);
            stringBuffer.append(a[((b3 & 15) << 2) | ((b4 & MessagePack.Code.NIL) >>> 6)]);

...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{FTPCodes.FILE_ACTION_NOT_TAKEN, 459}, IAreaCode.STR_AREA_CODE_JAPAN);
            ...
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            add(new int[]{489}, IAreaCode.STR_AREA_CODE_HONGKONG);
            add(new int[]{490, 499}, IAreaCode.STR_AREA_CODE_JAPAN);
            ...
            add(new int[]{690, 695}, IAreaCode.STR_AREA_CODE_CHINA);
            ...
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, DJILogPaths.LOG_AR);
            add(new int[]{780}, "CL");
            add(new int[]{784}, "PY");
            add(new int[]{785}, "PE");
            add(new int[]{786}, "EC");
            ...
            add(new int[]{955}, "MY");
            add(new int[]{958}, IAreaCode.STR_AREA_CODE_MACAU);
        }
    }
}

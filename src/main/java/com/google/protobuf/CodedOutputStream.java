...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static class ArrayEncoder extends CodedOutputStream {
            ...
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || Android.isOnAndroidDevice() || spaceLeft() < 5) {
                while ((value & -128) != 0) {
                    try {
                        ...
                        int i = this.position;
                        this.position = i + 1;
                        bArr[i] = (byte) ((value & CertificateBody.profileType) | 128);
                        value >>>= 7;
                    } catch (IndexOutOfBoundsException e) {
                        throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                    }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((value & -128) != 0) {
                    try {
                        ...
                        int i = this.position;
                        this.position = i + 1;
                        bArr[i] = (byte) ((((int) value) & CertificateBody.profileType) | 128);
                        value >>>= 7;
                    } catch (IndexOutOfBoundsException e) {
                        throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                    }
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) value) & CertificateBody.profileType) | 128));
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i4 = this.position;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while ((value & -128) != 0) {
                this.buffer.put((byte) ((value & CertificateBody.profileType) | 128));
                value >>>= 7;
            }
            try {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while ((-128 & value) != 0) {
                this.buffer.put((byte) ((((int) value) & CertificateBody.profileType) | 128));
                value >>>= 7;
            }
            try {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((value & CertificateBody.profileType) | 128));
                    value >>>= 7;
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((((int) value) & CertificateBody.profileType) | 128));
                    value >>>= 7;
                }
                long j2 = this.position;
                this.position = j2 + 1;
            ...
            while (this.position < this.limit) {
                ...
                long j4 = this.position;
                this.position = j4 + 1;
                UnsafeUtil.putByte(j4, (byte) ((((int) value) & CertificateBody.profileType) | 128));
                value >>>= 7;
            }
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.position), Long.valueOf(this.limit), 1));
        }
        ...
        public final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((value & CertificateBody.profileType) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
        ...
        public final void bufferUInt64NoTag(long value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) value) & CertificateBody.profileType) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((((int) value) & CertificateBody.profileType) | 128);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
    ...
    private static final class ByteOutputEncoder extends AbstractBufferedEncoder {
        ...
        ByteOutputEncoder(ByteOutput out2, int bufferSize) {
            super(bufferSize);
            if (out2 == null) {
                throw new NullPointerException(DJIUpServerManager.outFiles);
            }
            this.out = out2;
        }
    ...
    private static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        public void writeStringNoTag(java.lang.String r14) throws java.io.IOException {
            /*
                r13 = this;
                int r9 = r14.length()     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r4 = r9 * 3
                int r5 = computeUInt32SizeNoTag(r4)     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r9 = r5 + r4
                int r10 = r13.limit     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                if (r9 <= r10) goto L_0x001f
                byte[] r2 = new byte[r4]     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                r9 = 0
                int r0 = com.google.protobuf.Utf8.encode(r14, r2, r9, r4)     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                r13.writeUInt32NoTag(r0)     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                r9 = 0
                r13.writeLazy(r2, r9, r0)     // Catch:{ UnpairedSurrogateException -> 0x0065 }
            L_0x001e:
                return
            L_0x001f:
                int r9 = r5 + r4
                int r10 = r13.limit     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r11 = r13.position     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r10 = r10 - r11
                if (r9 <= r10) goto L_0x002b
                r13.doFlush()     // Catch:{ UnpairedSurrogateException -> 0x0065 }
            L_0x002b:
                int r9 = r14.length()     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r6 = computeUInt32SizeNoTag(r9)     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r8 = r13.position     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                if (r6 != r5) goto L_0x006a
                int r9 = r8 + r6
                r13.position = r9     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                byte[] r9 = r13.buffer     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r10 = r13.position     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r11 = r13.limit     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r12 = r13.position     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r11 = r11 - r12
                int r7 = com.google.protobuf.Utf8.encode(r14, r9, r10, r11)     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                r13.position = r8     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r9 = r7 - r8
                int r3 = r9 - r6
                r13.bufferUInt32NoTag(r3)     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                r13.position = r7     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
            L_0x0053:
                int r9 = r13.totalBytesWritten     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r9 = r9 + r3
                r13.totalBytesWritten = r9     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                goto L_0x001e
            L_0x0059:
                r1 = move-exception
                int r9 = r13.totalBytesWritten     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r10 = r13.position     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                int r10 = r10 - r8
                int r9 = r9 - r10
                r13.totalBytesWritten = r9     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                r13.position = r8     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                throw r1     // Catch:{ UnpairedSurrogateException -> 0x0065 }
            L_0x0065:
                r1 = move-exception
                r13.inefficientWriteStringNoTag(r14, r1)
                goto L_0x001e
            L_0x006a:
                int r3 = com.google.protobuf.Utf8.encodedLength(r14)     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                r13.bufferUInt32NoTag(r3)     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                byte[] r9 = r13.buffer     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r10 = r13.position     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                int r9 = com.google.protobuf.Utf8.encode(r14, r9, r10, r3)     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                r13.position = r9     // Catch:{ UnpairedSurrogateException -> 0x0059, ArrayIndexOutOfBoundsException -> 0x007c }
                goto L_0x0053
            L_0x007c:
                r1 = move-exception
                com.google.protobuf.CodedOutputStream$OutOfSpaceException r9 = new com.google.protobuf.CodedOutputStream$OutOfSpaceException     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                r9.<init>(r1)     // Catch:{ UnpairedSurrogateException -> 0x0065 }
                throw r9     // Catch:{ UnpairedSurrogateException -> 0x0065 }
            */

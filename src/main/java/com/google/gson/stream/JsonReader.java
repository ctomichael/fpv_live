...
public class JsonReader implements Closeable {
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        this.pos = 0;
        do {
            int total = this.f23in.read(buffer2, this.limit, buffer2.length - this.limit);
            if (total == -1) {
                return false;
            }
            this.limit += total;
    ...
    public String getPath() {
        StringBuilder result = new StringBuilder().append((char) Typography.dollar);

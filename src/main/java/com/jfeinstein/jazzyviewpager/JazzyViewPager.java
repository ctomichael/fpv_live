...
public class JazzyViewPager extends ViewPager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      com.jfeinstein.jazzyviewpager.JazzyViewPager.addView(android.view.View, int):void
      com.jfeinstein.jazzyviewpager.JazzyViewPager.addView(android.view.View, android.support.v4.view.ViewPager$LayoutParams):void
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      com.jfeinstein.jazzyviewpager.JazzyViewPager.addView(android.view.View, int, int):void
      com.jfeinstein.jazzyviewpager.JazzyViewPager.addView(android.view.View, int, android.support.v4.view.ViewPager$LayoutParams):void

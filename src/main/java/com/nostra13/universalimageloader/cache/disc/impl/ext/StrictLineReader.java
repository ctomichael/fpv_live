...
class StrictLineReader implements Closeable {
            ...
            while (true) {
                if (i2 == this.end) {
                    ByteArrayOutputStream out = new ByteArrayOutputStream((this.end - this.pos) + 80) {
                        /* class com.nostra13.universalimageloader.cache.disc.impl.ext.StrictLineReader.AnonymousClass1 */
    ...
    private void fillBuf() throws IOException {
        int result = this.f25in.read(this.buf, 0, this.buf.length);
        if (result == -1) {

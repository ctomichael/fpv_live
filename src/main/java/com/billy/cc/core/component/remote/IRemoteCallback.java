...
public interface IRemoteCallback extends IInterface {
    void callback(RemoteCCResult remoteCCResult) throws RemoteException;

    public static abstract class Stub extends Binder implements IRemoteCallback {
        private static final String DESCRIPTOR = "com.billy.cc.core.component.remote.IRemoteCallback";
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            RemoteCCResult _arg0;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = RemoteCCResult.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                    callback(_arg0);
            ...
            public void callback(RemoteCCResult remoteCCResult) throws RemoteException {
                ...
                try {
                    ...
                    if (remoteCCResult != null) {
                        _data.writeInt(1);
                        remoteCCResult.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }

...
class ChinaCertificatePins {
    static final Map<String, List<String>> CERTIFICATE_PINS = new HashMap<String, List<String>>() {
        /* class com.mapbox.android.telemetry.ChinaCertificatePins.AnonymousClass1 */

        {
            put("events.mapbox.cn", new ArrayList<String>() {
                /* class com.mapbox.android.telemetry.ChinaCertificatePins.AnonymousClass1.AnonymousClass1 */

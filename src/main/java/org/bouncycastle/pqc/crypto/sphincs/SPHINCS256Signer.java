...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddr, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        leafaddr2.subleaf = 0;
        while (leafaddr2.subleaf < 32) {
            Tree.l_tree(hashFunctions2, bArr5, (int) (PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID + (leafaddr2.subleaf * 32)), bArr7, (int) (leafaddr2.subleaf * 67 * 32), bArr4, 0);
            leafaddr2.subleaf++;
        }
        int i3 = 0;
        ...
        for (int i7 = 0; i7 < i2; i7++) {
            System.arraycopy(bArr5, ((32 >>> i7) * 32) + (((i6 >>> i7) ^ 1) * 32), bArr2, (i7 * 32) + i, 32);
        }
    ...
    static void validate_authpath(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, int i2, byte[] bArr4, int i3) {
        ...
        while (true) {
            ...
            if (i11 < i3 - 1) {
                i >>>= 1;
                if ((i & 1) != 0) {
                    hashFunctions2.hash_2n_n_mask(bArr5, 32, bArr5, 0, bArr4, (i11 + 7) * 2 * 32);
                    for (int i12 = 0; i12 < 32; i12++) {
                        bArr5[i12] = bArr3[i10 + i12];
                    }
                } else {
                    hashFunctions2.hash_2n_n_mask(bArr5, 0, bArr5, 0, bArr4, (i11 + 7) * 2 * 32);
                    for (int i13 = 0; i13 < 32; i13++) {
                        bArr5[i13 + 32] = bArr3[i10 + i13];
                    }
                }
                i8 = i10 + 32;
                i9 = i11 + 1;
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2) {
        ...
        leafaddr2.level = 12;
        leafaddr2.subleaf = (long) ((int) (31 & j));
        ...
        new Horst();
        int horst_sign = Horst.horst_sign(hashFunctions2, bArr3, 40, bArr6, bArr7, bArr8, bArr5) + 40;
        Wots wots = new Wots();
        for (int i5 = 0; i5 < 12; i5++) {
            leafaddr2.level = i5;
            Seed.get_seed(hashFunctions2, bArr7, 0, bArr9, leafaddr2);
            wots.wots_sign(hashFunctions2, bArr3, horst_sign, bArr6, bArr7, bArr8);
            int i6 = horst_sign + 2144;
            compute_authpath_wots(hashFunctions2, bArr6, bArr3, i6, leafaddr2, bArr9, bArr8, 5);
            horst_sign = i6 + 160;
    ...
    public boolean verify(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        while (true) {
            ...
            validate_authpath(hashFunctions2, bArr6, bArr5, (int) (31 & j2), bArr7, i8, bArr8, 5);
            j = j2 >> 5;
            i5 = i8 + 160;
            i6 = (i6 - 2144) - 160;
            i7++;

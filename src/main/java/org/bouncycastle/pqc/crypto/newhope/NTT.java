...
class NTT {
        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                while (i4 < 1023) {
                    ...
                    short s2 = sArr[i4 + i2] & UShort.MAX_VALUE;
                    int i6 = i5 + 1;
                    short s3 = sArr2[i5];
                    sArr[i4] = (short) (s + s2);
                    sArr[i4 + i2] = Reduce.montgomery(s3 * ((s + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - s2));
                    i4 += i2 * 2;
                    i5 = i6;
                }
            }
            ...
            for (int i8 = 0; i8 < i7; i8++) {
                ...
                int i10 = 0;
                while (i9 < 1023) {
                    short s4 = sArr[i9] & UShort.MAX_VALUE;
                    short s5 = sArr[i9 + i7] & UShort.MAX_VALUE;
                    int i11 = i10 + 1;
                    short s6 = sArr2[i10];
                    sArr[i9] = Reduce.barrett((short) (s4 + s5));
                    sArr[i9 + i7] = Reduce.montgomery(s6 * ((s4 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - s5));
                    i9 += i7 * 2;
                    i10 = i11;
                }
            }
    ...
    static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int i = 0; i < 1024; i++) {
            sArr[i] = Reduce.montgomery((sArr[i] & UShort.MAX_VALUE) * (sArr2[i] & UShort.MAX_VALUE));
        }
    }
}

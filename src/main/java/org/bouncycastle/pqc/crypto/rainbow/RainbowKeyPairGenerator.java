...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private void computePublicKey() {
        ...
        short[][][] sArr = (short[][][]) Array.newInstance(Short.TYPE, i, i2, i2);
        this.pub_singular = (short[][]) Array.newInstance(Short.TYPE, i, i2);
            ...
            for (int i5 = 0; i5 < length; i5++) {
                ...
                while (true) {
                    ...
                    for (int i10 = 0; i10 < length2; i10++) {
                        ...
                        this.pub_scalar[i3 + i5] = GF2Field.addElem(this.pub_scalar[i3 + i5], GF2Field.multElem(GF2Field.multElem(coeffBeta[i5][i9][i10], this.b2[i9]), this.b2[i10]));
                    }
                    i8 = i9 + 1;
                }
        ...
        short[][][] sArr3 = (short[][][]) Array.newInstance(Short.TYPE, i, i2, i2);
        short[][] sArr4 = (short[][]) Array.newInstance(Short.TYPE, i, i2);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [org.bouncycastle.pqc.crypto.rainbow.RainbowPublicKeyParameters, org.bouncycastle.pqc.crypto.rainbow.RainbowPrivateKeyParameters]
     candidates:

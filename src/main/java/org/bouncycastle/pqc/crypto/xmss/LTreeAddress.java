...
public final class LTreeAddress extends XMSSAddress {
    ...
    public byte[] toByteArray() {
        ...
        XMSSUtil.intToBytesBigEndianOffset(byteArray, this.lTreeAddress, 16);
        XMSSUtil.intToBytesBigEndianOffset(byteArray, this.treeHeight, 20);
        XMSSUtil.intToBytesBigEndianOffset(byteArray, this.treeIndex, 24);
        return byteArray;
    }
}

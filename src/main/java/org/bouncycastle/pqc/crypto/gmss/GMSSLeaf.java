...
public class GMSSLeaf {
    ...
    GMSSLeaf(Digest digest, int i2, int i3) {
        ...
        int ceil = (int) Math.ceil(((double) (this.mdsize << 3)) / ((double) i2));
        this.keysize = ceil + ((int) Math.ceil(((double) getLog((ceil << i2) + 1)) / ((double) i2)));
        this.two_power_w = 1 << i2;
        this.steps = (int) Math.ceil(((double) (((((1 << i2) - 1) * this.keysize) + 1) + this.keysize)) / ((double) i3));
    ...
    public String toString() {
        ...
        int i3 = 0;
        while (i3 < 4) {
            String str3 = statByte[i3] != null ? str2 + new String(Hex.encode(statByte[i3])) + " " : str2 + "null ";
            i3++;
            str2 = str3;
        }
        return str2;

...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [org.bouncycastle.pqc.crypto.gmss.GMSSPublicKeyParameters, org.bouncycastle.pqc.crypto.gmss.GMSSPrivateKeyParameters]
     candidates:
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            bArr[i2] = (byte[][]) Array.newInstance(Byte.TYPE, this.heightOfTrees[i2], this.mdLength);
            treehashArr[i2] = new Treehash[(this.heightOfTrees[i2] - this.K[i2])];
            if (i2 > 0) {
                bArr2[i2 - 1] = (byte[][]) Array.newInstance(Byte.TYPE, this.heightOfTrees[i2], this.mdLength);
        ...
        byte[][] bArr3 = (byte[][]) Array.newInstance(Byte.TYPE, this.numLayer, this.mdLength);
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            int i5 = i2;
            if (i4 >= (1 << this.heightOfTrees[i])) {
                break;
            }
            if (i4 == i3 && i5 < this.heightOfTrees[i] - this.K[i]) {

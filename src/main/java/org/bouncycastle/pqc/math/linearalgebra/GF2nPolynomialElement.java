...
public class GF2nPolynomialElement extends GF2nElement {
    private static final int[] bitMask = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1048576, 2097152, 4194304, 8388608, 16777216, 33554432, 67108864, 134217728, SQLiteDatabase.CREATE_IF_NECESSARY, 536870912, 1073741824, Integer.MIN_VALUE, 0};
    ...
    public GF2nPolynomialElement invertEEA() throws ArithmeticException {
        ...
        GF2Polynomial gF2Polynomial5 = new GF2Polynomial(this.mDegree + 32, "ONE");
        gF2Polynomial5.reduceN();
        GF2Polynomial gF2Polynomial6 = new GF2Polynomial(this.mDegree + 32);
        gF2Polynomial6.reduceN();
        GF2Polynomial gF2Polynomial7 = getGF2Polynomial();
        GF2Polynomial fieldPolynomial = this.mField.getFieldPolynomial();
        gF2Polynomial7.reduceN();
        GF2Polynomial gF2Polynomial8 = gF2Polynomial7;
        GF2Polynomial gF2Polynomial9 = gF2Polynomial6;
        GF2Polynomial gF2Polynomial10 = gF2Polynomial5;
        while (!gF2Polynomial8.isOne()) {
            gF2Polynomial8.reduceN();
            fieldPolynomial.reduceN();
            int length = gF2Polynomial8.getLength() - fieldPolynomial.getLength();
            if (length < 0) {
                length = -length;
                gF2Polynomial10.reduceN();
                gF2Polynomial = gF2Polynomial8;
                gF2Polynomial2 = fieldPolynomial;
                gF2Polynomial3 = gF2Polynomial10;
                gF2Polynomial4 = gF2Polynomial9;
            } else {
                gF2Polynomial = fieldPolynomial;
                gF2Polynomial2 = gF2Polynomial8;
                gF2Polynomial3 = gF2Polynomial9;
                gF2Polynomial4 = gF2Polynomial10;
            }
            gF2Polynomial2.shiftLeftAddThis(gF2Polynomial, length);
            gF2Polynomial4.shiftLeftAddThis(gF2Polynomial3, length);
            fieldPolynomial = gF2Polynomial;
            gF2Polynomial8 = gF2Polynomial2;
            gF2Polynomial9 = gF2Polynomial3;
            gF2Polynomial10 = gF2Polynomial4;
        }
        gF2Polynomial10.reduceN();
        return new GF2nPolynomialElement((GF2nPolynomialField) this.mField, gF2Polynomial10);
    }
    ...
    public GF2nPolynomialElement invertMAIA() throws ArithmeticException {
        ...
        GF2Polynomial gF2Polynomial5 = new GF2Polynomial(this.mDegree, "ONE");
        GF2Polynomial gF2Polynomial6 = new GF2Polynomial(this.mDegree);
        GF2Polynomial gF2Polynomial7 = getGF2Polynomial();
        GF2Polynomial fieldPolynomial = this.mField.getFieldPolynomial();
        GF2Polynomial gF2Polynomial8 = gF2Polynomial7;
        GF2Polynomial gF2Polynomial9 = gF2Polynomial6;
        GF2Polynomial gF2Polynomial10 = gF2Polynomial5;
        while (true) {
            if (!gF2Polynomial8.testBit(0)) {
                gF2Polynomial8.shiftRightThis();
                if (!gF2Polynomial10.testBit(0)) {
                    gF2Polynomial10.shiftRightThis();
                } else {
                    gF2Polynomial10.addToThis(this.mField.getFieldPolynomial());
                    gF2Polynomial10.shiftRightThis();
                }
            } else if (gF2Polynomial8.isOne()) {
                return new GF2nPolynomialElement((GF2nPolynomialField) this.mField, gF2Polynomial10);
            } else {
                gF2Polynomial8.reduceN();
                fieldPolynomial.reduceN();
                if (gF2Polynomial8.getLength() < fieldPolynomial.getLength()) {
                    gF2Polynomial = gF2Polynomial8;
                    gF2Polynomial2 = fieldPolynomial;
                    gF2Polynomial3 = gF2Polynomial10;
                    gF2Polynomial4 = gF2Polynomial9;

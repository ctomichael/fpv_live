...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    public Enumeration engineAliases() {
        ...
        while (keys3.hasMoreElements()) {
            ...
            if (hashtable.get(str) == null) {
                hashtable.put(str, IMemberProtocol.STRING_KEY);
            }
        }
    ...
    public Certificate[] engineGetCertificateChain(String str) {
        ...
        if (engineIsKeyEntry(str) && (engineGetCertificate = engineGetCertificate(str)) != null) {
            ...
            for (engineGetCertificate = engineGetCertificate(str); engineGetCertificate != null; engineGetCertificate = x509Certificate2) {
                X509Certificate x509Certificate3 = (X509Certificate) engineGetCertificate;
                ...
                if (x509Certificate == null) {
                    ...
                    if (!issuerDN.equals(x509Certificate3.getSubjectDN())) {
                        Enumeration keys2 = this.chainCerts.keys();
                        while (true) {
                            if (!keys2.hasMoreElements()) {
                                break;
                            }
                            X509Certificate x509Certificate4 = (X509Certificate) this.chainCerts.get(keys2.nextElement());
                            if (x509Certificate4.getSubjectDN().equals(issuerDN)) {
                                try {
                ...
                while (i != contentInfo.length) {
                    if (contentInfo[i].getContentType().equals(data)) {
                        ...
                        while (true) {
                            ...
                            SafeBag instance2 = SafeBag.getInstance(aSN1Sequence.getObjectAt(i3));
                            ...
                            if (instance5.getBagId().equals(certBag)) {
                                ...
                                while (objects2.hasMoreElements()) {
                                    ...
                                    if (aSN1ObjectIdentifier2.equals(pkcs_9_at_friendlyName)) {
                                        str2 = ((DERBMPString) aSN1Primitive).getString();
                                    ...
                                    aSN1OctetString5 = aSN1OctetString2;
                                    str6 = str2;
                                }
                                String str7 = new String(Hex.encode(aSN1OctetString5.getOctets()));
                                if (str6 == null) {
                                    this.keys.put(str7, unwrapKey2);
                                } else {
                                ...
                                while (objects3.hasMoreElements()) {
                                    ...
                                    if (instance9.size() > 0) {
                                        ...
                                        if (instance8.equals(pkcs_9_at_friendlyName)) {
                                            str8 = ((DERBMPString) aSN1Primitive3).getString();
                                        ...
                                        aSN1OctetString6 = aSN1OctetString;
                                    }
                                    aSN1OctetString = aSN1OctetString6;
                                    aSN1OctetString6 = aSN1OctetString;
                                }
                                String str9 = new String(Hex.encode(aSN1OctetString6.getOctets()));
                                if (str8 == null) {
                    ...
                    try {
                            ...
                            while (objects4.hasMoreElements()) {
                                ...
                                if (instance13.size() > 0) {
                                    ...
                                    if (instance12.equals(pkcs_9_at_friendlyName)) {
                                        ...
                                        str = str10;
                                        aSN1OctetString7 = (ASN1OctetString) aSN1Primitive4;
                                    }
                                    str10 = str;
                                }
                                str = str10;
                        ...
                        if (!z2) {
                            if (aSN1OctetString7 != null) {
                                this.keyCerts.put(new String(Hex.encode(aSN1OctetString7.getOctets())), generateCertificate);
                            }
                            if (str10 != null) {
                                this.certs.put(str10, generateCertificate);
                            }
                        } else if (this.keyCerts.isEmpty()) {
                            String str11 = new String(Hex.encode(createSubjectKeyId(generateCertificate.getPublicKey()).getKeyIdentifier()));
                            this.keyCerts.put(str11, generateCertificate);
                            this.keys.put(str11, this.keys.remove("unmarked"));
                        }
                        i6 = i7 + 1;
                    } catch (Exception e3) {

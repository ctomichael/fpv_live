...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i + IMemberProtocol.PARAM_SEPERATOR + i2, str);
            configurableProvider.addAlgorithm("KeyGenerator." + str, PREFIX + "$SkeinMacKeyGenerator_" + i + "_" + i2);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i + IMemberProtocol.PARAM_SEPERATOR + i2, str);
        }

...
public class CipherSpi extends BaseCipherSpi {
    ...
    private byte[] getOutput() throws BadPaddingException {
        try {
            ...
            throw new BadPaddingException("unable to decrypt block") {
                /* class org.bouncycastle.jcajce.provider.asymmetric.elgamal.CipherSpi.AnonymousClass1 */
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException {
        ...
        if (algorithmParameterSpec == null) {
            ...
            CipherParameters parametersWithRandom = secureRandom != null ? new ParametersWithRandom(generatePrivateKeyParameter, secureRandom) : generatePrivateKeyParameter;
            switch (i) {
                case 1:
                case 3:

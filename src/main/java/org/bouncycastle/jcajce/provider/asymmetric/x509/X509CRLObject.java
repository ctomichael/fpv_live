...
class X509CRLObject extends X509CRL {
    ...
    private Set loadCRLEntries() {
        ...
        while (revokedCertificateEnumeration.hasMoreElements()) {
            ...
            x500Name = (!this.isIndirect || !cRLEntry.hasExtensions() || (extension = cRLEntry.getExtensions().getExtension(Extension.certificateIssuer)) == null) ? x500Name : X500Name.getInstance(GeneralNames.getInstance(extension.getParsedValue()).getNames()[0].getName());
        }
        return hashSet;
    }
    ...
    public void verify(PublicKey publicKey) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature instance;
        try {
            instance = this.bcHelper.createSignature(getSigAlgName());
        } catch (Exception e) {

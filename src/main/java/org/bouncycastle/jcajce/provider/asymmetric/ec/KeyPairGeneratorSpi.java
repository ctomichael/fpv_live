...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class EC extends KeyPairGeneratorSpi {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertPoint(org.bouncycastle.math.ec.ECCurve, java.security.spec.ECPoint, boolean):org.bouncycastle.math.ec.ECPoint
         arg types: [org.bouncycastle.math.ec.ECCurve, java.security.spec.ECPoint, int]
         candidates:
        ...
        public ECNamedCurveSpec createNamedCurveSpec(String str) throws InvalidAlgorithmParameterException {
            ...
            if (domainParametersFromName == null) {
                try {
                    ...
                    if (byOID == null && (byOID = (X9ECParameters) this.configuration.getAdditionalECParameters().get(new ASN1ObjectIdentifier(str))) == null) {

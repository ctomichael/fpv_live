    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof PKCS12Key) {
            ...
            if (bCPBEKey.getParam() != null) {
                ...
                makePBEParameters = PBE.Util.makePBEParameters(bCPBEKey, algorithmParameterSpec, this.cipher.getAlgorithmName());
                this.pbeSpec = (PBEParameterSpec) algorithmParameterSpec;
            } else {
        ...
        if (this.ivLength != 0 && !(cipherParameters instanceof ParametersWithIV)) {
            ...
            if (i == 1 || i == 3) {
                ...
                this.ivParam = (ParametersWithIV) parametersWithIV2;

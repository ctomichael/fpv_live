...
public class SM3Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        while (i15 < 16) {
            ...
            int FF0 = (i16 ^ i18) + i10 + FF0(i7, i8, i9) + this.W1[i15];
            int i19 = (i8 << 9) | (i8 >>> 23);
            int i20 = (i12 << 19) | (i12 >>> 13);
            int P0 = P0(i14 + GG0(i11, i12, i13) + i18 + this.W[i15]);
            i15++;
            i14 = i13;
            i12 = i11;
            i10 = i9;
        ...
        while (i21 < 64) {
            int i25 = (i7 << 12) | (i7 >>> 20);
            int i26 = i25 + i11 + T[i21];
            int i27 = (i26 >>> 25) | (i26 << 7);
            int FF1 = (i25 ^ i27) + i23 + FF1(i7, i24, i9) + this.W1[i21];
            int i28 = (i24 << 9) | (i24 >>> 23);
            int i29 = (i22 << 19) | (i22 >>> 13);
            int P02 = P0(i14 + GG1(i11, i22, i13) + i27 + this.W[i21]);
            i21++;
            i14 = i13;
            i22 = i11;
            i23 = i9;

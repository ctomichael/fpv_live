...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [org.bouncycastle.crypto.digests.RIPEMD160Digest], assign insn: null */
    ...
    public void processBlock() {
        ...
        int RL319 = RL(RL314, 10) + RL285 + this.H1;
        this.H1 = RL317 + this.H2 + RL287;
        this.H2 = RL315 + this.H3 + RL286;
    ...
    public void processWord(byte[] bArr, int i) {
        ...
        int i2 = this.xOff;
        this.xOff = i2 + 1;
        iArr[i2] = (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << Tnaf.POW_2_WIDTH) | ((bArr[i + 3] & 255) << 24);
        if (this.xOff == 16) {
            processBlock();
        }
    }

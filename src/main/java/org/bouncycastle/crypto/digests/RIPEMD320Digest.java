...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    /* JADX WARN: Type inference failed for: r12v0, types: [org.bouncycastle.crypto.digests.RIPEMD320Digest], assign insn: null */
    ...
    public void processBlock() {
        ...
        this.H0 = RL284 + this.H0;
        this.H1 += RL287;
        this.H2 += RL285;
        this.H3 += RL288;
        this.H4 += RL318;
        this.H5 = RL316 + this.H5;
        this.H6 += RL319;
        this.H7 += RL317;
        this.H8 += RL320;
        this.H9 += RL286;

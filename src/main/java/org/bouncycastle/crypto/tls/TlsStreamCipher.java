...
public class TlsStreamCipher implements TlsCipher {
    ...
    public TlsStreamCipher(TlsContext tlsContext, StreamCipher streamCipher, StreamCipher streamCipher2, Digest digest, Digest digest2, int i, boolean z) throws IOException {
        ...
        KeyParameter keyParameter3 = new KeyParameter(calculateKeyBlock, digestSize3, i);
        int i2 = digestSize3 + i;
        KeyParameter keyParameter4 = new KeyParameter(calculateKeyBlock, i2, i);
        if (i2 + i != digestSize) {
        ...
        if (z) {
            ...
            cipherParameters2 = new ParametersWithIV(keyParameter2, bArr);

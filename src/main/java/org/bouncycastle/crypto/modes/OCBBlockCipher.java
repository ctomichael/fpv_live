...
public class OCBBlockCipher implements AEADBlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (i == 0) {
            ...
            for (int i3 = 0; i3 < 16; i3++) {
                i2++;
                this.OffsetMAIN_0[i3] = (byte) (((this.Stretch[i2] & 255) << i) | ((this.Stretch[i2] & 255) >>> (8 - i)));
            }
        }
        this.hashBlockPos = 0;
        this.mainBlockPos = 0;
    ...
    public int processNonce(byte[] bArr) {
        ...
        byte b = bArr2[15] & 63;
        bArr2[15] = (byte) (bArr2[15] & MessagePack.Code.NIL);
        if (this.KtopInput == null || !Arrays.areEqual(bArr2, this.KtopInput)) {
            ...
            for (int i = 0; i < 8; i++) {
                this.Stretch[i + 16] = (byte) (bArr3[i] ^ bArr3[i + 1]);
            }
        }
        return b;
    }

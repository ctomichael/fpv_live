...
public class VMPCMac implements Mac {
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        ...
        for (int i3 = 0; i3 < 768; i3++) {
            this.s = this.P[(this.s + this.P[i3 & 255] + this.T[i3 & 31]) & 255];
            byte b2 = this.P[i3 & 255];
            this.P[i3 & 255] = this.P[this.s & 255];
            this.P[this.s & 255] = b2;
        }
        ...
        for (int i4 = 0; i4 < 20; i4++) {
            this.s = this.P[(this.s + this.P[i4 & 255]) & 255];
            bArr2[i4] = this.P[(this.P[this.P[this.s & 255] & 255] + 1) & 255];
    ...
    public void update(byte b) throws IllegalStateException {
        ...
        this.x1 = this.P[(((byte) (this.P[(this.P[this.P[this.s & 255] & 255] + 1) & 255] ^ b)) + this.x1 + this.s) & 255];
        this.T[this.g & 31] = (byte) (this.T[this.g & 31] ^ this.x1);
        this.T[(this.g + 1) & 31] = (byte) (this.T[(this.g + 1) & 31] ^ this.x2);
        this.T[(this.g + 2) & 31] = (byte) (this.T[(this.g + 2) & 31] ^ this.x3);
        this.T[(this.g + 3) & 31] = (byte) (this.T[(this.g + 3) & 31] ^ this.x4);

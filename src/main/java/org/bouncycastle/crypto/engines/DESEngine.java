...
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP8 = {268439616, 4096, 262144, 268701760, SQLiteDatabase.CREATE_IF_NECESSARY, 268439616, 64, SQLiteDatabase.CREATE_IF_NECESSARY, IMemberProtocol.CMDID_ACCOUNT_CENTER_EMAIL_REGISTER, 268697600, 268701760, 266240, 268701696, 266304, 4096, 64, 268697600, 268435520, 268439552, 4160, 266240, IMemberProtocol.CMDID_ACCOUNT_CENTER_EMAIL_REGISTER, 268697664, 268701696, 4160, 0, 0, 268697664, 268435520, 268439552, 266304, 262144, 266304, 262144, 268701696, 4096, 64, 268697664, 4096, 266304, 268439552, 64, 268435520, 268697600, 268697664, SQLiteDatabase.CREATE_IF_NECESSARY, 262144, 268439616, 0, 268701760, IMemberProtocol.CMDID_ACCOUNT_CENTER_EMAIL_REGISTER, 268435520, 268697600, 268439552, 268439616, 0, 268701760, 266240, 266240, 4160, 4160, IMemberProtocol.CMDID_ACCOUNT_CENTER_EMAIL_REGISTER, SQLiteDatabase.CREATE_IF_NECESSARY, 268701696};
    ...
    private static final byte[] pc1 = {56, TarHeader.LF_NORMAL, 40, 32, 24, Tnaf.POW_2_WIDTH, 8, 0, 57, TarHeader.LF_LINK, 41, 33, 25, 17, 9, 1, 58, TarHeader.LF_SYMLINK, 42, 34, 26, 18, 10, 2, 59, TarHeader.LF_CHR, 43, 35, 62, TarHeader.LF_FIFO, 46, 38, 30, 22, 14, 6, 61, TarHeader.LF_DIR, 45, 37, 29, 21, Draft_75.CR, 5, 60, TarHeader.LF_BLK, 44, 36, 28, 20, 12, 4, 27, 19, 11, 3};
    private static final byte[] pc2 = {Draft_75.CR, Tnaf.POW_2_WIDTH, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, 11, 3, 25, 7, 15, 6, 26, 19, 12, 1, 40, TarHeader.LF_CHR, 30, 36, 46, TarHeader.LF_FIFO, 29, 39, TarHeader.LF_SYMLINK, 44, 32, 47, 43, TarHeader.LF_NORMAL, 38, TarHeader.LF_CONTIG, 33, TarHeader.LF_BLK, 45, 41, TarHeader.LF_LINK, 35, 28, 31};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        byte b9 = ((b7 >>> 2) ^ b8) & TarHeader.LF_CHR;
        byte b10 = b8 ^ b9;
        byte b11 = b7 ^ (b9 << 2);

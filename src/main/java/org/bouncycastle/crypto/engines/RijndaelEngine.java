...
public class RijndaelEngine implements BlockCipher {
    ...
    private static final byte[] logtable = {0, 0, 25, 1, TarHeader.LF_SYMLINK, 2, 26, MessagePack.Code.BIN32, 75, MessagePack.Code.EXT8, 27, 104, TarHeader.LF_CHR, -18, MessagePack.Code.MAP32, 3, 100, 4, MessagePack.Code.NEGFIXINT_PREFIX, 14, TarHeader.LF_BLK, -115, -127, -17, 76, 113, 8, MessagePack.Code.EXT16, -8, 105, 28, MessagePack.Code.NEVER_USED, 125, MessagePack.Code.FALSE, 29, -75, -7, -71, 39, 106, 77, -28, -90, 114, -102, MessagePack.Code.EXT32, 9, 120, 101, 47, -118, 5, 33, 15, -31, 36, 18, -16, -126, 69, TarHeader.LF_DIR, -109, MessagePack.Code.STR16, -114, -106, -113, MessagePack.Code.STR32, -67, TarHeader.LF_FIFO, MessagePack.Code.INT8, MessagePack.Code.UINT32, -108, 19, 92, MessagePack.Code.INT32, -15, 64, 70, -125, 56, 102, MessagePack.Code.ARRAY32, -3, TarHeader.LF_NORMAL, -65, 6, -117, 98, -77, 37, -30, -104, 34, -120, -111, Tnaf.POW_2_WIDTH, 126, 110, 72, MessagePack.Code.TRUE, -93, -74, 30, 66, 58, 107, 40, 84, -6, -123, 61, -70, 43, 121, 10, 21, -101, -97, 94, MessagePack.Code.FLOAT32, 78, MessagePack.Code.FIXEXT1, -84, -27, -13, 115, -89, 87, -81, 88, -88, 80, -12, -22, MessagePack.Code.FIXEXT4, 116, 79, -82, -23, MessagePack.Code.FIXEXT2, -25, -26, -83, -24, 44, MessagePack.Code.FIXEXT8, 117, 122, -21, 22, 11, -11, 89, MessagePack.Code.FLOAT64, 95, -80, -100, -87, 81, MessagePack.Code.FIXSTR_PREFIX, ByteCompanionObject.MAX_VALUE, 12, -10, 111, 23, MessagePack.Code.BIN8, 73, -20, MessagePack.Code.FIXEXT16, 67, 31, 45, -92, 118, 123, -73, MessagePack.Code.UINT8, -69, 62, 90, -5, 96, -79, -122, 59, 82, -95, 108, -86, 85, 41, -99, -105, -78, -121, MessagePack.Code.FIXARRAY_PREFIX, 97, -66, MessagePack.Code.ARRAY16, -4, PSSSigner.TRAILER_IMPLICIT, -107, MessagePack.Code.UINT64, MessagePack.Code.UINT16, TarHeader.LF_CONTIG, 63, 91, MessagePack.Code.INT16, 83, 57, -124, 60, 65, -94, 109, 71, 20, 42, -98, 93, 86, -14, MessagePack.Code.INT64, -85, 68, 17, -110, MessagePack.Code.STR8, 35, 32, 46, -119, -76, 124, -72, 38, 119, -103, -29, -91, 103, 74, -19, MessagePack.Code.MAP16, MessagePack.Code.BIN16, TarHeader.LF_LINK, -2, 24, Draft_75.CR, 99, -116, Byte.MIN_VALUE, MessagePack.Code.NIL, -9, 112, 7};
    ...
    static byte[][] shifts1 = {new byte[]{0, 24, Tnaf.POW_2_WIDTH, 8}, new byte[]{0, 32, 24, Tnaf.POW_2_WIDTH}, new byte[]{0, 40, 32, 24}, new byte[]{0, TarHeader.LF_NORMAL, 40, 24}, new byte[]{0, 56, 40, 32}};
    private long A0;
    private long A1;
    private long A2;
    private long A3;
    ...
    private void InvMixColumn() {
        ...
        while (i < this.BC) {
            ...
            long mul0xe = (((long) ((((mul0xe(b3) ^ mul0xb(b4)) ^ mul0xd(b)) ^ mul0x9(b2)) & 255)) << i) | j2;
    ...
    private void MixColumn() {
        ...
        while (i < this.BC) {
            ...
            long mul0x2 = (((long) ((((mul0x2(i4) ^ mul0x3(i5)) ^ i2) ^ i3) & 255)) << i) | j2;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        int i4 = 0;
        for (int i5 = 0; i5 < i && i4 < (this.ROUNDS + 1) * (this.BC / 8); i5++) {
            for (int i6 = 0; i6 < 4; i6++) {
                long[] jArr2 = jArr[i4 / (this.BC / 8)];
                jArr2[i6] = jArr2[i6] | (((long) (bArr2[i6][i5] & 255)) << ((i4 * 8) % this.BC));
            }
            i4++;
        }
        int i7 = 0;
        ...
        while (i8 < (this.ROUNDS + 1) * (this.BC / 8)) {
            for (int i9 = 0; i9 < 4; i9++) {
                byte[] bArr3 = bArr2[i9];
                bArr3[0] = (byte) (bArr3[0] ^ S[bArr2[(i9 + 1) % 4][i - 1] & 255]);
            }
            byte[] bArr4 = bArr2[0];
            int i10 = i7 + 1;
            ...
            if (i <= 6) {
                for (int i11 = 1; i11 < i; i11++) {
                    for (int i12 = 0; i12 < 4; i12++) {
                        ...
                        bArr5[i11] = (byte) (bArr5[i11] ^ bArr2[i12][i11 - 1]);
                    }
                }
            } else {
                int i13 = 1;
                while (true) {
                    ...
                    if (i14 < 4) {
                        for (int i15 = 0; i15 < 4; i15++) {
                            ...
                            bArr6[i14] = (byte) (bArr6[i14] ^ bArr2[i15][i14 - 1]);
                        }
                        i13 = i14 + 1;
                    } else {
                        for (int i16 = 0; i16 < 4; i16++) {
                            byte[] bArr7 = bArr2[i16];
                            bArr7[4] = (byte) (bArr7[4] ^ S[bArr2[i16][3] & 255]);
                        }
                        for (int i17 = 5; i17 < i; i17++) {
                            for (int i18 = 0; i18 < 4; i18++) {
                                byte[] bArr8 = bArr2[i18];
                                bArr8[i17] = (byte) (bArr8[i17] ^ bArr2[i18][i17 - 1]);
                            }
                        }
                    }
                }
            }
            for (int i19 = 0; i19 < i && i8 < (this.ROUNDS + 1) * (this.BC / 8); i19++) {
                for (int i20 = 0; i20 < 4; i20++) {
                    long[] jArr3 = jArr[i8 / (this.BC / 8)];
                    jArr3[i20] = jArr3[i20] | (((long) (bArr2[i20][i19] & 255)) << ((i8 * 8) % this.BC));
                }
                i8++;
            }
            i7 = i10;

...
public final class TnepresEngine extends SerpentEngineBase {
    /* JADX WARN: Type inference failed for: r4v0, types: [org.bouncycastle.crypto.engines.TnepresEngine], assign insn: null */
    ...
    public void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        this.X0 = this.wKey[128] ^ Pack.bigEndianToInt(bArr, i + 12);
    ...
    public int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        if (length == 0) {
            ...
            for (int i3 = 8; i3 < 16; i3++) {
                iArr[i3] = rotateLeft(((((iArr[i3 - 8] ^ iArr[i3 - 5]) ^ iArr[i3 - 3]) ^ iArr[i3 - 1]) ^ -1640531527) ^ (i3 - 8), 11);
            }
            System.arraycopy(iArr, 8, iArr2, 0, 8);
            for (int i4 = 8; i4 < 132; i4++) {
                iArr2[i4] = rotateLeft(((((iArr2[i4 - 8] ^ iArr2[i4 - 5]) ^ iArr2[i4 - 3]) ^ iArr2[i4 - 1]) ^ -1640531527) ^ i4, 11);
            }

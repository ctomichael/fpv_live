...
public class Grain128Engine implements StreamCipher {
    ...
    private int getOutput() {
        ...
        return ((((((i ^ ((((i2 & i9) & ((this.lfsr[2] >>> 31) | (this.lfsr[3] << 1))) ^ ((((i10 & i2) ^ (i11 & i12)) ^ (i9 & i13)) ^ (i14 & i15))) ^ ((this.lfsr[2] >>> 29) | (this.lfsr[3] << 3)))) ^ i3) ^ i4) ^ i5) ^ i6) ^ i7) ^ i8;
    }
    ...
    private int getOutputNFSR() {
        ...
        return ((((((((((i ^ i7) ^ i11) ^ ((this.nfsr[2] >>> 27) | (this.nfsr[3] << 5))) ^ this.nfsr[3]) ^ (i2 & i15)) ^ (i3 & i4)) ^ (i5 & i6)) ^ (i8 & i12)) ^ (i9 & i10)) ^ (i13 & i14)) ^ (i16 & i17);
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            int i3 = i;
            if (i2 < this.nfsr.length) {
                this.nfsr[i2] = (this.workingKey[i3 + 3] << 24) | ((this.workingKey[i3 + 2] << Tnaf.POW_2_WIDTH) & 16711680) | ((this.workingKey[i3 + 1] << 8) & 65280) | (this.workingKey[i3] & 255);
                this.lfsr[i2] = (this.workingIV[i3 + 3] << 24) | ((this.workingIV[i3 + 2] << Tnaf.POW_2_WIDTH) & 16711680) | ((this.workingIV[i3 + 1] << 8) & 65280) | (this.workingIV[i3] & 255);
                i = i3 + 4;
                i2++;
            } else {
                return;

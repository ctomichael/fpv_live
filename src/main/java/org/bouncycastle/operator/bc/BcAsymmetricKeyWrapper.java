...
public abstract class BcAsymmetricKeyWrapper extends AsymmetricKeyWrapper {
    ...
    public byte[] generateWrappedKey(GenericKey genericKey) throws OperatorException {
        ...
        CipherParameters parametersWithRandom = this.random != null ? new ParametersWithRandom(asymmetricKeyParameter, this.random) : asymmetricKeyParameter;
        try {
            byte[] keyBytes = OperatorUtils.getKeyBytes(genericKey);
            createAsymmetricWrapper.init(true, parametersWithRandom);

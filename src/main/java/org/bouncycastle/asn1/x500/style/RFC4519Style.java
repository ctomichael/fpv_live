...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    static {
        ...
        DefaultSymbols.put(cn, LanguageUtils.CN_DJI_LANG_CODE);
        DefaultSymbols.put(dc, "dc");
        DefaultSymbols.put(description, ResponseBase.STRING_DESCRIPTION);
        ...
        DefaultSymbols.put(sn, ResponseBase.STRING_SN);
        ...
        DefaultSymbols.put(uid, ResponseBase.STRING_UID);
        ...
        DefaultLookUp.put(LanguageUtils.CN_DJI_LANG_CODE, cn);
        DefaultLookUp.put("dc", dc);
        DefaultLookUp.put(ResponseBase.STRING_DESCRIPTION, description);
        ...
        DefaultLookUp.put(ResponseBase.STRING_SN, sn);
        ...
        DefaultLookUp.put(ResponseBase.STRING_UID, uid);

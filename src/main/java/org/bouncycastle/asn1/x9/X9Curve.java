...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID x9FieldID, ASN1Sequence aSN1Sequence) {
        ...
        if (this.fieldIdentifier.equals(prime_field)) {
            ...
            this.curve = new ECCurve.F2m(intValue4, intValue, intValue2, intValue3, new X9FieldElement(intValue4, intValue, intValue2, intValue3, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(intValue4, intValue, intValue2, intValue3, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
        } else {

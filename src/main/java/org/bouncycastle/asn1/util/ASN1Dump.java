...
public class ASN1Dump {
    ...
    static void _dumpAsString(String str, boolean z, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
        ...
        if (aSN1Primitive instanceof ASN1Sequence) {
            ...
            if (aSN1Primitive instanceof BEROctetString) {
                stringBuffer.append(str + "BER Constructed Octet String" + IMemberProtocol.STRING_SEPERATOR_LEFT + aSN1OctetString.getOctets().length + "] ");
            } else {
                stringBuffer.append(str + "DER Octet String" + IMemberProtocol.STRING_SEPERATOR_LEFT + aSN1OctetString.getOctets().length + "] ");
            }
            if (z) {
            ...
            stringBuffer.append(str + "DER Bit String" + IMemberProtocol.STRING_SEPERATOR_LEFT + dERBitString.getBytes().length + ", " + dERBitString.getPadBits() + "] ");
            if (z) {
            ...
            if (dERExternal.getDirectReference() != null) {
                stringBuffer.append(str5 + "Direct Reference: " + dERExternal.getDirectReference().getId() + lineSeparator);
            }
            if (dERExternal.getIndirectReference() != null) {
                stringBuffer.append(str5 + "Indirect Reference: " + dERExternal.getIndirectReference().toString() + lineSeparator);
            }
            if (dERExternal.getDataValueDescriptor() != null) {
                _dumpAsString(str5, z, dERExternal.getDataValueDescriptor(), stringBuffer);
            }
            stringBuffer.append(str5 + "Encoding: " + dERExternal.getEncoding() + lineSeparator);
    ...
    private static String outputApplicationSpecific(String str, String str2, boolean z, ASN1Primitive aSN1Primitive, String str3) {
        ...
        try {
            ...
            stringBuffer.append(str2 + str + " ApplicationSpecific[" + instance.getApplicationTag() + IMemberProtocol.STRING_SEPERATOR_RIGHT + str3);

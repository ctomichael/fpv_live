...
public interface CMCObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_cmc_confirmCertAcceptance = id_cmc.branch(AmapLoc.RESULT_TYPE_NEW_FUSED);
    ...
    public static final ASN1ObjectIdentifier id_cmc_getCRL = id_cmc.branch(Values.NavigationModeEnterException.SPORT_MODE);

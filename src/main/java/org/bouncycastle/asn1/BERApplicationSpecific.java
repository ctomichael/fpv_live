...
public class BERApplicationSpecific extends ASN1ApplicationSpecific {
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: org.bouncycastle.asn1.BERApplicationSpecific.<init>(boolean, int, org.bouncycastle.asn1.ASN1Encodable):void
     arg types: [int, int, org.bouncycastle.asn1.ASN1Encodable]
     candidates:
      org.bouncycastle.asn1.BERApplicationSpecific.<init>(boolean, int, byte[]):void
      org.bouncycastle.asn1.BERApplicationSpecific.<init>(boolean, int, org.bouncycastle.asn1.ASN1Encodable):void */

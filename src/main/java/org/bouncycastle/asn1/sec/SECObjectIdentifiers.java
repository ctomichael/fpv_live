...
public interface SECObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier sect193r1 = ellipticCurve.branch(AmapLoc.RESULT_TYPE_NEW_FUSED);
    ...
    public static final ASN1ObjectIdentifier sect283k1 = ellipticCurve.branch(Values.NavigationModeEnterException.SPORT_MODE);

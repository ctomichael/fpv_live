...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: org.bouncycastle.asn1.x500.X500Name.getInstance(org.bouncycastle.asn1.ASN1TaggedObject, boolean):org.bouncycastle.asn1.x500.X500Name
     arg types: [org.bouncycastle.asn1.ASN1TaggedObject, int]
     candidates:
      org.bouncycastle.asn1.x500.X500Name.getInstance(org.bouncycastle.asn1.x500.X500NameStyle, java.lang.Object):org.bouncycastle.asn1.x500.X500Name
      org.bouncycastle.asn1.x500.X500Name.getInstance(org.bouncycastle.asn1.ASN1TaggedObject, boolean):org.bouncycastle.asn1.x500.X500Name */
    ...
    private int[] parseIPv6(String str) {
        ...
        if (i3 != iArr.length) {
            System.arraycopy(iArr, i2, iArr, iArr.length - (i3 - i2), i3 - i2);
            for (int i5 = i2; i5 != iArr.length - (i3 - i2); i5++) {
                iArr[i5] = 0;
            }
        }
        return iArr;

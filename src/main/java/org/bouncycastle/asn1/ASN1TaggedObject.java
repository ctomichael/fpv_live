...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
    ...
    public boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        ...
        if (!this.obj.toASN1Primitive().equals(aSN1TaggedObject.obj.toASN1Primitive())) {
            return false;
        }
    }
    ...
    public String toString() {
        return IMemberProtocol.STRING_SEPERATOR_LEFT + this.tagNo + IMemberProtocol.STRING_SEPERATOR_RIGHT + this.obj;
    }
}

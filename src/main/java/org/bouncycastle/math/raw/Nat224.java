...
public abstract class Nat224 {
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        for (int i4 = 1; i4 < 7; i4++) {
            ...
            long j17 = 0 + (j16 * j) + (((long) iArr3[i3 + 0]) & 4294967295L);
            iArr3[i3 + 0] = (int) j17;
            long j18 = (j17 >>> 32) + (j16 * j2) + (((long) iArr3[i3 + 1]) & 4294967295L);
            iArr3[i3 + 1] = (int) j18;
            long j19 = (j18 >>> 32) + (j16 * j3) + (((long) iArr3[i3 + 2]) & 4294967295L);
            iArr3[i3 + 2] = (int) j19;
            long j20 = (j19 >>> 32) + (j16 * j4) + (((long) iArr3[i3 + 3]) & 4294967295L);
            iArr3[i3 + 3] = (int) j20;
            long j21 = (j20 >>> 32) + (j16 * j5) + (((long) iArr3[i3 + 4]) & 4294967295L);
            iArr3[i3 + 4] = (int) j21;
            long j22 = (j21 >>> 32) + (j16 * j6) + (((long) iArr3[i3 + 5]) & 4294967295L);
            iArr3[i3 + 5] = (int) j22;
            long j23 = (j22 >>> 32) + (j16 * j7) + (((long) iArr3[i3 + 6]) & 4294967295L);
            iArr3[i3 + 6] = (int) j23;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i = 1; i < 7; i++) {
            ...
            iArr3[i + 5] = (int) j22;
            long j23 = (j22 >>> 32) + (j16 * j7) + (((long) iArr3[i + 6]) & 4294967295L);
            iArr3[i + 6] = (int) j23;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        for (int i4 = 0; i4 < 7; i4++) {
            ...
            long j10 = 0 + (j9 * j) + (((long) iArr3[i3 + 0]) & 4294967295L);
            iArr3[i3 + 0] = (int) j10;
            long j11 = (j10 >>> 32) + (j9 * j2) + (((long) iArr3[i3 + 1]) & 4294967295L);
            iArr3[i3 + 1] = (int) j11;
            long j12 = (j11 >>> 32) + (j9 * j3) + (((long) iArr3[i3 + 2]) & 4294967295L);
            iArr3[i3 + 2] = (int) j12;
            long j13 = (j12 >>> 32) + (j9 * j4) + (((long) iArr3[i3 + 3]) & 4294967295L);
            iArr3[i3 + 3] = (int) j13;
            long j14 = (j13 >>> 32) + (j9 * j5) + (((long) iArr3[i3 + 4]) & 4294967295L);
            iArr3[i3 + 4] = (int) j14;
            long j15 = (j14 >>> 32) + (j9 * j6) + (((long) iArr3[i3 + 5]) & 4294967295L);
            iArr3[i3 + 5] = (int) j15;
            long j16 = (j15 >>> 32) + (j9 * j7) + (((long) iArr3[i3 + 6]) & 4294967295L);
            iArr3[i3 + 6] = (int) j16;
            long j17 = j8 + (((long) iArr3[i3 + 7]) & 4294967295L) + (j16 >>> 32);
            iArr3[i3 + 7] = (int) j17;
            j8 = j17 >>> 32;
            i3++;
        }
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            iArr3[i + 5] = (int) j15;
            long j16 = (j15 >>> 32) + (j9 * j7) + (((long) iArr3[i + 6]) & 4294967295L);
            iArr3[i + 6] = (int) j16;
    ...
    public static int mulWordAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        iArr2[i3 + 5] = (int) j7;
        long j8 = (j7 >>> 32) + (j * (((long) iArr[i2 + 6]) & 4294967295L)) + (((long) iArr2[i3 + 6]) & 4294967295L);
        iArr2[i3 + 6] = (int) j8;
        return (int) (j8 >>> 32);
    }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                long j38 = (j31 & 4294967295L) + (j * j36);
                int i18 = (int) j38;
                iArr2[i2 + 6] = i17 | (i18 << 1);
                int i19 = i18 >>> 31;
                long j39 = (j38 >>> 32) + (j36 * j5) + (j32 & 4294967295L);
                long j40 = (j39 >>> 32) + (j36 * j8) + (j33 & 4294967295L);
                long j41 = (j40 >>> 32) + (j36 * j12) + (j34 & 4294967295L);
                long j42 = (j41 >>> 32) + (j36 * j19) + (j35 & 4294967295L);
                long j43 = (j42 >>> 32) + (j36 * j27) + (j37 & 4294967295L);
                long j44 = (j43 >>> 32) + (((long) iArr2[i2 + 12]) & 4294967295L) + (j37 >>> 32);
                int i20 = (int) j39;
                ...
                iArr2[i2 + 13] = (i30 >>> 31) | ((iArr2[i2 + 13] + ((int) (j44 >>> 32))) << 1);
                return;
            }
            i3 = i6;
        }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j42 = (j41 >>> 32) + (j36 * j19) + (j35 & 4294967295L);
                long j43 = (j42 >>> 32) + (j36 * j27) + (j37 & 4294967295L);
                long j44 = (j43 >>> 32) + (((long) iArr2[12]) & 4294967295L) + (j37 >>> 32);
                int i18 = (int) j39;
                iArr2[7] = i17 | (i18 << 1);
                int i19 = i18 >>> 31;
                int i20 = (int) j40;
                ...
                int i28 = (int) j44;
                iArr2[12] = i27 | (i28 << 1);
                iArr2[13] = (i28 >>> 31) | ((iArr2[13] + ((int) (j44 >>> 32))) << 1);
                return;
            }
            i = i4;
        }

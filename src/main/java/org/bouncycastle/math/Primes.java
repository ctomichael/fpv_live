...
public abstract class Primes {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (!modPow.equals(ONE) && !modPow.equals(subtract)) {
                    ...
                    while (true) {
                        ...
                        bigInteger2 = bigInteger4.modPow(TWO, bigInteger);
    ...
    private static int extract32(byte[] bArr) {
        ...
        while (i < min) {
            i++;
            i2 = ((bArr[bArr.length - (i + 1)] & 255) << (i * 8)) | i2;
        }
        return i2;
    }
    ...
    private static boolean implHasAnySmallFactors(BigInteger bigInteger) {
        ...
        if (intValue9 % 173 == 0 || intValue9 % 179 == 0 || intValue9 % 181 == 0 || intValue9 % CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256 == 0) {
            return true;
        }
        int intValue10 = bigInteger.mod(BigInteger.valueOf((long) 1596463769)).intValue();
        return intValue10 % CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256 == 0 || intValue10 % CipherSuite.TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA256 == 0 || intValue10 % 199 == 0 || intValue10 % 211 == 0;
    }

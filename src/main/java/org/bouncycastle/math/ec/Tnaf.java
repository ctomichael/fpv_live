...
class Tnaf {
    ...
    public static BigInteger[] getLucas(byte b, int i, boolean z) {
        ...
        if (b == 1 || b == -1) {
            ...
            while (i2 < i) {
                BigInteger subtract = (b == 1 ? bigInteger3 : bigInteger3.negate()).subtract(bigInteger4.shiftLeft(1));
                i2++;
    ...
    public static ECPoint.AbstractF2m multiplyFromTnaf(ECPoint.AbstractF2m abstractF2m, byte[] bArr) {
        ...
        while (length >= 0) {
            ...
            byte b = bArr[length];
            if (b != 0) {
                ECPoint.AbstractF2m tauPow = abstractF2m3.tauPow(i3);
                ECPoint.AbstractF2m abstractF2m4 = b > 0 ? abstractF2m : abstractF2m2;
                i = 0;
    ...
    public static ECPoint.AbstractF2m multiplyRTnaf(ECPoint.AbstractF2m abstractF2m, BigInteger bigInteger) {
        ...
        return multiplyTnaf(abstractF2m, partModReduction(bigInteger, fieldSize, (byte) intValue, si, mu, (byte) 10));
    }
        ...
        if (b == 1 || b == -1) {
            ...
            while (true) {
                ...
                if (bigInteger5.testBit(0)) {
                    ...
                    if (z) {
                        add = bigInteger5.subtract(zTauElementArr[intValue].u);
                        bigInteger3 = bigInteger3.subtract(zTauElementArr[intValue].v);
                    } else {
                        add = bigInteger5.add(zTauElementArr[intValue].u);
                        bigInteger3 = bigInteger3.add(zTauElementArr[intValue].v);
                    }
                    bigInteger4 = add;
                } else {
                    bArr[i] = 0;

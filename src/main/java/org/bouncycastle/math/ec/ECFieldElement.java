    ...
    public static class Fp extends ECFieldElement {
        ...
        private BigInteger[] lucasSequence(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            ...
            while (true) {
                ...
                BigInteger modMult = modMult(bigInteger10, bigInteger9);
                if (bigInteger3.testBit(i)) {
                    bigInteger5 = modMult(modMult, bigInteger2);
                    bigInteger6 = modMult(bigInteger6, bigInteger11);
                    bigInteger7 = modReduce(bigInteger11.multiply(bigInteger4).subtract(bigInteger.multiply(modMult)));
                    modReduce = modReduce(bigInteger11.multiply(bigInteger11).subtract(bigInteger5.shiftLeft(1)));
                } else {
                    bigInteger6 = modReduce(bigInteger6.multiply(bigInteger4).subtract(modMult));
                    modReduce = modReduce(bigInteger11.multiply(bigInteger4).subtract(bigInteger.multiply(modMult)));
                    bigInteger7 = modReduce(bigInteger4.multiply(bigInteger4).subtract(modMult.shiftLeft(1)));
                    bigInteger5 = modMult;
                }
                i--;
                bigInteger9 = bigInteger5;
                bigInteger10 = modMult;
                bigInteger11 = modReduce;
            }
            BigInteger modMult2 = modMult(bigInteger10, bigInteger9);
            BigInteger modMult3 = modMult(modMult2, bigInteger2);
            BigInteger modReduce2 = modReduce(bigInteger6.multiply(bigInteger4).subtract(modMult2));
            BigInteger modReduce3 = modReduce(bigInteger11.multiply(bigInteger4).subtract(bigInteger.multiply(modMult2)));
            BigInteger modMult4 = modMult(modMult2, modMult3);
            for (int i2 = 1; i2 <= lowestSetBit; i2++) {
                modReduce2 = modMult(modReduce2, modReduce3);
                modReduce3 = modReduce(modReduce3.multiply(modReduce3).subtract(modMult4.shiftLeft(1)));
                modMult4 = modMult(modMult4, modMult4);
            }

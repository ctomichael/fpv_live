...
class LongArray implements Cloneable {
    ...
    /* JADX WARN: Type inference failed for: r0v12, types: [byte[]], assign insn: 0x0012: SGET  (r0v12 ? I:byte[]) =  org.bouncycastle.math.ec.LongArray.bitLengths byte[] */
    /* JADX WARN: Type inference failed for: r0v13, types: [byte], assign insn: 0x0014: AGET  (r0v13 ? I:byte A[IMMUTABLE_TYPE]) = (r0v12 ? I:byte[] A[IMMUTABLE_TYPE]), (r2v2 int) */
    /* JADX WARNING: Incorrect type for immutable var: ssa=byte, code=int, for r0v13, types: [byte], assign insn: ?: TERNARY(r0v13 ? I:byte A[IMMUTABLE_TYPE]) = ((r0v9 int) == (0 int)) ? (wrap: ? : 0x0014: AGET  (r0v13 ? I:byte A[IMMUTABLE_TYPE]) = (wrap: ? : 0x0012: SGET  (r0v12 ? I:byte[]) =  org.bouncycastle.math.ec.LongArray.bitLengths byte[]), (r2v2 int)) : (wrap: int : 0x001e: ARITH  (r0v11 int) = (wrap: byte : 0x001c: AGET  (r0v10 byte A[IMMUTABLE_TYPE]) = (wrap: byte[] : 0x001a: SGET  (r2v5 byte[]) =  org.bouncycastle.math.ec.LongArray.bitLengths byte[]), (r0v9 int)) + (8 byte)) */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int bitLength(long r4) {
        /*
            r0 = 32
            long r2 = r4 >>> r0
            int r2 = (int) r2
        ...
        L_0x000a:
            ...
            byte[] r0 = org.bouncycastle.math.ec.LongArray.bitLengths
            byte r0 = r0[r2]
        L_0x0016:
            int r0 = r0 + r1
            return r0
        L_0x0018:
            ...
            goto L_0x000a
        L_0x001a:
            byte[] r2 = org.bouncycastle.math.ec.LongArray.bitLengths
            byte r0 = r2[r0]
            int r0 = r0 + 8
            goto L_0x0016
        L_0x0021:
    ...
    private static long interleave2_32to64(int i) {
        return (((long) (INTERLEAVE2_TABLE[i & 255] | (INTERLEAVE2_TABLE[(i >>> 8) & 255] << 16))) & BodyPartID.bodyIdMax) | ((((long) (INTERLEAVE2_TABLE[(i >>> 16) & 255] | (INTERLEAVE2_TABLE[i >>> 24] << 16))) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    private static long interleave2_n(long j, int i) {
        ...
        while (i > 1) {
            i -= 2;
            j2 = (interleave4_16to64(((int) (j2 >>> 48)) & 65535) << 3) | interleave4_16to64(((int) j2) & 65535) | (interleave4_16to64(((int) (j2 >>> 16)) & 65535) << 1) | (interleave4_16to64(((int) (j2 >>> 32)) & 65535) << 2);
        }
        if (i <= 0) {
            return j2;
        }
    ...
    private static long interleave3_13to65(int i) {
        return (((long) INTERLEAVE5_TABLE[i & CertificateBody.profileType]) & BodyPartID.bodyIdMax) | ((((long) INTERLEAVE5_TABLE[i >>> 7]) & BodyPartID.bodyIdMax) << 35);
    }

    private static long interleave3_21to63(int i) {
        int i2 = INTERLEAVE3_TABLE[i & CertificateBody.profileType];
        int i3 = INTERLEAVE3_TABLE[(i >>> 7) & CertificateBody.profileType];
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) INTERLEAVE3_TABLE[i >>> 14]) & BodyPartID.bodyIdMax) << 42) | ((((long) i3) & BodyPartID.bodyIdMax) << 21);
    }

    private static long interleave4_16to64(int i) {
        return (((long) INTERLEAVE4_TABLE[i & 255]) & BodyPartID.bodyIdMax) | ((((long) INTERLEAVE4_TABLE[i >>> 8]) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        iArr2[1] = i7;
        System.arraycopy(longArray2.m_ints, 0, jArr2, i7, i5);
        int i8 = i7;
        for (int i9 = 2; i9 < 16; i9++) {
            i8 += i7;
            iArr2[i9] = i8;
            if ((i9 & 1) == 0) {
                shiftUp(jArr2, i8 >>> 1, jArr2, i8, i7, 1);
            } else {
                add(jArr2, i7, jArr2, i8 - i7, jArr2, i8, i7);
            }
        }
        long[] jArr3 = new long[jArr2.length];
        shiftUp(jArr2, 0, jArr3, 0, jArr2.length, 4);
        long[] jArr4 = longArray3.m_ints;
        ...
        for (int i10 = 0; i10 < i4; i10++) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                addBoth(jArr5, i11, jArr2, iArr2[((int) j2) & 15], jArr3, iArr2[((int) j3) & 15], i7);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            length -= i6;
            if (length == 0) {
                return reduceResult(jArr5, 0, i6, i, iArr);
            }
            addShiftedUp(jArr5, length - i6, jArr5, length, i6, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        long[] jArr2 = new long[(i9 + i6 + 1)];
        interleave(longArray3.m_ints, 0, jArr2, 0, i4, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr2, i4, i5);
        int i11 = i4;
        for (int i12 = 1; i12 < 8; i12++) {
            i11 += i7;
            shiftUp(jArr2, i4, jArr2, i11, i7, i12);
        }
        int i13 = 15;
        int i14 = 0;
        while (true) {
            ...
            do {
                ...
                while (true) {
                    int i18 = ((int) j2) & i13;
                    if (i18 != 0) {
                        add(jArr2, iArr2[i18] + i15, jArr2, i17, i7);
                    }
                    i16++;
                    if (i16 == 8) {
                        break;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i10 = 56; i10 >= 0; i10 -= 8) {
            for (int i11 = 1; i11 < i4; i11 += 2) {
                int i12 = (int) (jArr4[i11] >>> i10);
                addBoth(jArr5, i11 - 1, jArr2, iArr2[i12 & 15], jArr3, iArr2[(i12 >>> 4) & 15], i7);
            }
            shiftUp(jArr5, 0, i6, 8);
        }
        for (int i13 = 56; i13 >= 0; i13 -= 8) {
            for (int i14 = 0; i14 < i4; i14 += 2) {
                int i15 = (int) (jArr4[i14] >>> i13);
                addBoth(jArr5, i14, jArr2, iArr2[i15 & 15], jArr3, iArr2[(i15 >>> 4) & 15], i7);
            }
            if (i13 > 0) {
                shiftUp(jArr5, 0, i6, 8);
            }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i4 == 1) {
            ...
            long[] jArr = new long[i6];
            multiplyWord(j, longArray2.m_ints, i5, jArr, 0);
            return new LongArray(jArr, 0, i6);
        }
        int i7 = ((i2 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        long[] jArr2 = new long[(i7 << 4)];
        ...
        while (true) {
            length -= i6;
            if (length == 0) {
                return new LongArray(jArr5, 0, i6);
            }
            addShiftedUp(jArr5, length - i6, jArr5, length, i6, 8);
        }
    }
    ...
    public BigInteger toBigInteger() {
        ...
        for (int i4 = usedLength - 2; i4 >= 0; i4--) {
            long j2 = this.m_ints[i4];
            int i5 = 7;
            while (i5 >= 0) {
                bArr2[i] = (byte) ((int) (j2 >>> (i5 * 8)));
                i5--;
                i++;
            }
        }

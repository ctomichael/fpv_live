...
public class SecT131Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        long j = jArr[0];
        long j2 = jArr[1];
        long j3 = M44 & ((jArr[2] << 40) ^ (j2 >>> 24));
        long j4 = ((j2 << 20) ^ (j >>> 44)) & M44;
        long j5 = j & M44;
        long j6 = jArr2[0];
        long j7 = jArr2[1];
        long j8 = ((jArr2[2] << 40) ^ (j7 >>> 24)) & M44;
        ...
        long j24 = j22 & M44;
        long j25 = (j16 ^ j21) ^ (j23 >>> 44);
        long j26 = j23 & M44;
        long j27 = (j24 >>> 1) ^ ((1 & j26) << 43);
        long j28 = j27 ^ (j27 << 1);
        long j29 = j28 ^ (j28 << 2);
        long j30 = j29 ^ (j29 << 4);
        long j31 = j30 ^ (j30 << 8);
        ...
        long j34 = ((j26 >>> 1) ^ ((1 & j25) << 43)) ^ (j33 >>> 43);
        long j35 = j34 ^ (j34 << 1);
        long j36 = j35 ^ (j35 << 2);
        long j37 = j36 ^ (j36 << 4);
        long j38 = j37 ^ (j37 << 8);
    ...
    protected static void implMulw(long j, long j2, long[] jArr, int i) {
        ...
        int i2 = (int) j;
        long j3 = 0;
        long j4 = (jArr2[i2 & 7] ^ (jArr2[(i2 >>> 3) & 7] << 3)) ^ (jArr2[(i2 >>> 6) & 7] << 6);
        int i3 = 33;
        do {
            int i4 = (int) (j >>> i3);
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j8 = (j3 ^ ((((j5 >>> 3) ^ (j5 >>> 1)) ^ j5) ^ (j5 << 5))) ^ (j6 >>> 59);
        long j9 = j8 >>> 3;
        jArr2[0] = (((j7 ^ j9) ^ (j9 << 2)) ^ (j9 << 3)) ^ (j9 << 8);
        jArr2[1] = ((j2 ^ ((j5 << 61) ^ (j5 << 63))) ^ ((((j6 >>> 3) ^ (j6 >>> 1)) ^ j6) ^ (j6 << 5))) ^ (j9 >>> 56);
        jArr2[2] = M03 & j8;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j = BodyPartID.bodyIdMax & unshuffle3;
        create64[1] = unshuffle3 >>> 32;
        multiply(create64, ROOT_Z, jArr2);
        jArr2[0] = jArr2[0] ^ ((BodyPartID.bodyIdMax & unshuffle) | (unshuffle2 << 32));
        jArr2[1] = jArr2[1] ^ j;
    }

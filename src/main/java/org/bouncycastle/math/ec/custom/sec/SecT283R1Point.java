...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply.isZero()) {
                return new SecT283R1Point(curve, multiply, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT283R1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{multiply2}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT283R1Point(curve, square2, (isOne ? eCFieldElement : eCFieldElement.multiply(eCFieldElement3)).squarePlusProduct(add, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2}, this.withCompression);
    }

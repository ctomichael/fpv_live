...
public class SecT571Field {
    ...
    protected static void implMultiplyPrecomp(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        for (int i5 = 56; i5 >= 0; i5 -= 8) {
            for (int i6 = 0; i6 < 9; i6 += 2) {
                ...
                int i8 = (((i7 >>> 4) & 15) + 16) * 9;
                addBothTo(jArr2, (i7 & 15) * 9, jArr2, i8, jArr3, i6);
            }
            if (i5 > 0) {
    ...
    protected static void implMulwAcc(long[] jArr, long j, long[] jArr2, int i) {
        ...
        while (true) {
            ...
            if (i4 < 9) {
                long j3 = jArr[i4];
                long j4 = jArr3[((int) j3) & 31] ^ j2;
                j2 = 0;
                int i5 = 60;
                do {
                    long j5 = jArr3[((int) (j3 >>> i5)) & 31];
                    j4 ^= j5 << i5;
                    j2 ^= j5 >>> (-i5);
                    i5 -= 5;
                } while (i5 > 0);
                ...
                int i7 = i + i4;
                jArr2[i7] = j4 ^ jArr2[i7];
                i3 = i4 + 1;
            } else {
                int i8 = i + 9;
                jArr2[i8] = j2 ^ jArr2[i8];
                return;
            }
        }
    }
    ...
    public static long[] precompMultiplicand(long[] jArr) {
        ...
        for (int i2 = 7; i2 > 0; i2--) {
            i += 18;
            Nat.shiftUpBit64(9, jArr2, i >>> 1, 0, jArr2, i);
            reduce5(jArr2, i);
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            create642[i2] = (unshuffle2 & -4294967296L) | (unshuffle >>> 32);
        }

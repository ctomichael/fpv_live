...
public class SecT283Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        implMulw(jArr4[2] ^ j9, jArr5[2] ^ j10, jArr6, 24);
        ...
        long j15 = j12 ^ ((jArr6[11] ^ jArr6[12]) ^ j14);
        jArr3[2] = j15;
        long j16 = j11 ^ j14;
        ...
        long j21 = jArr6[17] ^ j20;
        jArr3[8] = j21;
        long j22 = (j17 ^ j20) ^ (jArr6[15] ^ jArr6[16]);
        jArr3[7] = j22;
        long j23 = j13 ^ j22;
        long j24 = (jArr6[19] ^ jArr6[20]) ^ (jArr6[25] ^ jArr6[24]);
        jArr3[4] = j23 ^ (j24 ^ (jArr6[18] ^ jArr6[23]));
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j13 = j2 ^ ((((j7 << 37) ^ (j7 << 42)) ^ (j7 << 44)) ^ (j7 << 49));
        long j14 = j ^ ((((j6 << 37) ^ (j6 << 42)) ^ (j6 << 44)) ^ (j6 << 49));
        long j15 = j13 ^ ((j6 >>> 15) ^ (((j6 >>> 27) ^ (j6 >>> 22)) ^ (j6 >>> 20)));
        long j16 = j11 >>> 27;
        jArr2[0] = (((j14 ^ j16) ^ (j16 << 5)) ^ (j16 << 7)) ^ (j16 << 12);
        jArr2[1] = j15;
        jArr2[2] = j12 ^ ((j7 >>> 15) ^ (((j7 >>> 27) ^ (j7 >>> 22)) ^ (j7 >>> 20)));
        jArr2[3] = j10 ^ ((j8 >>> 15) ^ (((j8 >>> 27) ^ (j8 >>> 22)) ^ (j8 >>> 20)));
        jArr2[4] = M27 & j11;
    }

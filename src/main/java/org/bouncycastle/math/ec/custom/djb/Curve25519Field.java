...
public class Curve25519Field {
    ...
    private static int addPExtTo(int[] iArr) {
        ...
        long j5 = j4 + (((long) iArr[15]) & 4294967295L) + (((long) (PExt[15] + 1)) & 4294967295L);
        iArr[15] = (int) j5;
        return (int) (j5 >> 32);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int i2 = iArr2[7];
        iArr2[7] = Nat.addWordTo(7, ((Nat256.mulByWordAddTo(19, iArr, iArr2) << 1) + ((i2 >>> 31) - (i >>> 31))) * 19, iArr2) + (i2 & Integer.MAX_VALUE);
        if (Nat256.gte(iArr2, P)) {
            subPFrom(iArr2);
        }
    }

...
public class SecP256R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j15 = j6 + j7;
        long j16 = j14 - j9;
        long j17 = 0 + (((((long) iArr[0]) & 4294967295L) - j12) - j16);
        iArr2[0] = (int) j17;
        long j18 = (j17 >> 32) + ((((((long) iArr[1]) & 4294967295L) + j10) - j13) - j15);
        iArr2[1] = (int) j18;
        long j19 = (j18 >> 32) + (((((long) iArr[2]) & 4294967295L) + j11) - j14);
        iArr2[2] = (int) j19;
        long j20 = ((((j12 << 1) + (((long) iArr[3]) & 4294967295L)) + j16) - j15) + (j19 >> 32);
        iArr2[3] = (int) j20;
        long j21 = ((j6 + ((((long) iArr[4]) & 4294967295L) + (j13 << 1))) - j10) + (j20 >> 32);
        iArr2[4] = (int) j21;
        long j22 = (j21 >> 32) + (((((long) iArr[5]) & 4294967295L) + (j14 << 1)) - j11);
        iArr2[5] = (int) j22;
        long j23 = (j22 >> 32) + (((long) iArr[6]) & 4294967295L) + (j15 << 1) + j16;
        iArr2[6] = (int) j23;
        long j24 = (((j8 + ((((long) iArr[7]) & 4294967295L) + (j7 << 1))) - j11) - j13) + (j23 >> 32);
        iArr2[7] = (int) j24;

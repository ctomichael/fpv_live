...
public class SecT131R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (multiply.isZero()) {
                return new SecT131R1Point(curve, multiply, curve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT131R1Point(curve, multiply, squarePlusProduct, new ECFieldElement[]{multiply2}, this.withCompression);
    }

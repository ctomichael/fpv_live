...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger[] extEuclidBezout(BigInteger[] bigIntegerArr) {
        ...
        while (bigInteger2.compareTo(ECConstants.ONE) > 0) {
            BigInteger[] divideAndRemainder = bigInteger9.divideAndRemainder(bigInteger2);
            BigInteger bigInteger10 = divideAndRemainder[0];
            BigInteger bigInteger11 = divideAndRemainder[1];
            BigInteger subtract = bigInteger8.subtract(bigInteger10.multiply(bigInteger4));
    ...
    private static BigInteger[] extEuclidGLV(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        while (true) {
            ...
            BigInteger subtract = bigInteger5.subtract(bigInteger7.multiply(bigInteger4));
            if (isLessThanSqrt(bigInteger2, bigInteger)) {
                return new BigInteger[]{bigInteger6, bigInteger5, bigInteger2, bigInteger4, bigInteger8, subtract};
            }

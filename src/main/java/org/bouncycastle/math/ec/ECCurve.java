    ...
    public ECPoint decodePoint(byte[] bArr) {
        ...
        switch (b2) {
            ...
            case 3:
                ...
                validatePoint = decompressPoint(b2 & 1, BigIntegers.fromUnsignedByteArray(bArr, 1, fieldSize));
            ...
            case 4:
                if (bArr.length == (fieldSize * 2) + 1) {
                    validatePoint = validatePoint(BigIntegers.fromUnsignedByteArray(bArr, 1, fieldSize), BigIntegers.fromUnsignedByteArray(bArr, fieldSize + 1, fieldSize));
                    break;
                } else {
            ...
            default:
                ...
                if (i3 != 0) {
                    ...
                    for (int i5 = 0; i5 < i3; i5++) {
                        int i6 = iArr[i5];
                        eCPointArr[i6] = eCPointArr[i6].normalize(eCFieldElementArr[i5]);
                    }
                    return;
                }
                return;

...
public abstract class Pack {
    public static int bigEndianToInt(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        return (bArr[i] << 24) | ((bArr[i2] & 255) << Tnaf.POW_2_WIDTH) | ((bArr[i3] & 255) << 8) | (bArr[i3 + 1] & 255);
    }
    ...
    public static int littleEndianToInt(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        return (bArr[i] & 255) | ((bArr[i2] & 255) << 8) | ((bArr[i3] & 255) << Tnaf.POW_2_WIDTH) | (bArr[i3 + 1] << 24);
    }
    ...
    public static long littleEndianToLong(byte[] bArr, int i) {
        return (((long) littleEndianToInt(bArr, i)) & BodyPartID.bodyIdMax) | ((((long) littleEndianToInt(bArr, i + 4)) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    public static void longToBigEndian(long j, byte[] bArr, int i) {
        ...
        intToBigEndian((int) (BodyPartID.bodyIdMax & j), bArr, i + 4);
    }

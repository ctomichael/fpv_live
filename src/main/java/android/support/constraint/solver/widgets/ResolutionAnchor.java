...
public class ResolutionAnchor extends ResolutionNode {
    ...
    public String toString() {
        ...
        if (this.resolvedTarget == this) {
            return IMemberProtocol.STRING_SEPERATOR_LEFT + this.myAnchor + ", RESOLVED: " + this.resolvedOffset + "]  type: " + sType(this.type);
        }
        return IMemberProtocol.STRING_SEPERATOR_LEFT + this.myAnchor + ", RESOLVED: " + this.resolvedTarget + ":" + this.resolvedOffset + "] type: " + sType(this.type);
    }

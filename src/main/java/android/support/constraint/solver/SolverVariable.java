...
public class SolverVariable {
    ...
    private static String getUniqueName(Type type, String prefix) {
        ...
        switch (type) {
            ...
            case UNKNOWN:
                StringBuilder append5 = new StringBuilder().append(GPSTagConstants.GPS_TAG_GPS_STATUS_VALUE_MEASUREMENT_INTEROPERABILITY);
                int i5 = uniqueId + 1;
                uniqueId = i5;
    ...
    public String strengthsToString() {
        String representation = this + IMemberProtocol.STRING_SEPERATOR_LEFT;

...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String mimeType, @NonNull String filter) {
        ...
        return mimeTypeAgainstFilter(mimeType.split(IMemberProtocol.PARAM_SEPERATOR), filter.split(IMemberProtocol.PARAM_SEPERATOR));
    }
    ...
    public static String matches(@Nullable String mimeType, @NonNull String[] filters) {
        ...
        String[] mimeTypeParts = mimeType.split(IMemberProtocol.PARAM_SEPERATOR);
        for (String filter : filters) {
            if (mimeTypeAgainstFilter(mimeTypeParts, filter.split(IMemberProtocol.PARAM_SEPERATOR))) {
                return filter;
            }
        }
        return null;
    ...
    public static String matches(@Nullable String[] mimeTypes, @NonNull String filter) {
        ...
        String[] filterParts = filter.split(IMemberProtocol.PARAM_SEPERATOR);
        for (String mimeType : mimeTypes) {
            if (mimeTypeAgainstFilter(mimeType.split(IMemberProtocol.PARAM_SEPERATOR), filterParts)) {
                return mimeType;
            }
        }
        return null;

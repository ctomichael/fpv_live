        ...
        public void connect(String pkg, int pid, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                ...
                public void run() {
                    ...
                    ConnectionRecord connection = new ConnectionRecord(str, i, i2, bundle, serviceCallbacks);
                    MediaBrowserServiceCompat.this.mCurConnection = connection;
                    connection.root = MediaBrowserServiceCompat.this.onGetRoot(str, i2, bundle);
                    MediaBrowserServiceCompat.this.mCurConnection = null;
        ...
        Result<List<MediaBrowserCompat.MediaItem>> result = new Result<List<MediaBrowserCompat.MediaItem>>(parentId) {
            ...
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                ...
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord.callbacks.asBinder()) == connectionRecord) {
                    ...
                    try {
                        connectionRecord.callbacks.onLoadChildren(str, filteredList, bundle, bundle2);
                    } catch (RemoteException e) {

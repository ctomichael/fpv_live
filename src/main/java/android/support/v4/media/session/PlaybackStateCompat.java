...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Parcelable.Creator<PlaybackStateCompat> CREATOR = new Parcelable.Creator<PlaybackStateCompat>() {
        ...
        public PlaybackStateCompat createFromParcel(Parcel in2) {
            return new PlaybackStateCompat(in2);
        }
    ...
    PlaybackStateCompat(Parcel in2) {
        this.mState = in2.readInt();
        this.mPosition = in2.readLong();
        this.mSpeed = in2.readFloat();
        this.mUpdateTime = in2.readLong();
        this.mBufferedPosition = in2.readLong();
        this.mActions = in2.readLong();
        this.mErrorMessage = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in2);
        this.mCustomActions = in2.createTypedArrayList(CustomAction.CREATOR);
        this.mActiveItemId = in2.readLong();
        this.mExtras = in2.readBundle(MediaSessionCompat.class.getClassLoader());
        this.mErrorCode = in2.readInt();
    }
    ...
    public long getCurrentPosition(Long timeDiff) {
        return Math.max(0L, this.mPosition + ((long) (((float) (timeDiff != null ? timeDiff.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime)) * this.mSpeed)));
    }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        CustomAction(Parcel in2) {
            this.mAction = in2.readString();
            this.mName = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in2);
            this.mIcon = in2.readInt();
            this.mExtras = in2.readBundle(MediaSessionCompat.class.getClassLoader());
        }

...
public class MediaSessionCompat {
    ...
    public static final class Token implements Parcelable {
        public static final Parcelable.Creator<Token> CREATOR = new Parcelable.Creator<Token>() {
            ...
            public Token createFromParcel(Parcel in2) {
                Object readStrongBinder;
                if (Build.VERSION.SDK_INT >= 21) {
                    readStrongBinder = in2.readParcelable(null);
                } else {
                    readStrongBinder = in2.readStrongBinder();
                }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        ...
        ResultReceiverWrapper(Parcel in2) {
            this.mResultReceiver = (ResultReceiver) ResultReceiver.CREATOR.createFromParcel(in2);
        }

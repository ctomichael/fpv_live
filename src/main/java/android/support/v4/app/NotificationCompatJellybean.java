...
class NotificationCompatJellybean {
    ...
    public static android.support.v4.app.NotificationCompat.Action getAction(android.app.Notification r10, int r11) {
        /*
            java.lang.Object r8 = android.support.v4.app.NotificationCompatJellybean.sActionsLock
            monitor-enter(r8)
            java.lang.Object[] r3 = getActionObjectsLocked(r10)     // Catch:{ IllegalAccessException -> 0x003d }
            if (r3 == 0) goto L_0x004a
            r2 = r3[r11]     // Catch:{ IllegalAccessException -> 0x003d }
            r0 = 0
            android.os.Bundle r5 = getExtras(r10)     // Catch:{ IllegalAccessException -> 0x003d }
            if (r5 == 0) goto L_0x0021
            java.lang.String r6 = "android.support.actionExtras"
            android.util.SparseArray r1 = r5.getSparseParcelableArray(r6)     // Catch:{ IllegalAccessException -> 0x003d }
            if (r1 == 0) goto L_0x0021
            java.lang.Object r0 = r1.get(r11)     // Catch:{ IllegalAccessException -> 0x003d }
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ IllegalAccessException -> 0x003d }
        L_0x0021:
            java.lang.reflect.Field r6 = android.support.v4.app.NotificationCompatJellybean.sActionIconField     // Catch:{ IllegalAccessException -> 0x003d }
            int r9 = r6.getInt(r2)     // Catch:{ IllegalAccessException -> 0x003d }
            java.lang.reflect.Field r6 = android.support.v4.app.NotificationCompatJellybean.sActionTitleField     // Catch:{ IllegalAccessException -> 0x003d }
            java.lang.Object r6 = r6.get(r2)     // Catch:{ IllegalAccessException -> 0x003d }
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6     // Catch:{ IllegalAccessException -> 0x003d }
            java.lang.reflect.Field r7 = android.support.v4.app.NotificationCompatJellybean.sActionIntentField     // Catch:{ IllegalAccessException -> 0x003d }
            java.lang.Object r7 = r7.get(r2)     // Catch:{ IllegalAccessException -> 0x003d }
            android.app.PendingIntent r7 = (android.app.PendingIntent) r7     // Catch:{ IllegalAccessException -> 0x003d }
            android.support.v4.app.NotificationCompat$Action r6 = readAction(r9, r6, r7, r0)     // Catch:{ IllegalAccessException -> 0x003d }
        ...
        L_0x003d:
            ...
            android.util.Log.e(r6, r7, r4)     // Catch:{ all -> 0x004d }
            r6 = 1
            android.support.v4.app.NotificationCompatJellybean.sActionsAccessFailed = r6     // Catch:{ all -> 0x004d }
        L_0x004a:
            monitor-exit(r8)     // Catch:{ all -> 0x004d }
            r6 = 0
            goto L_0x003c

...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            FullSpanItem(Parcel in2) {
                ...
                this.mHasUnwantedGapAfter = in2.readInt() != 1 ? false : z;
                int spanCount = in2.readInt();
                if (spanCount > 0) {
                    this.mGapPerSpan = new int[spanCount];
                    in2.readIntArray(this.mGapPerSpan);
                }
            }
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel in2) {
            ...
            this.mSpanOffsetsSize = in2.readInt();
            if (this.mSpanOffsetsSize > 0) {
                this.mSpanOffsets = new int[this.mSpanOffsetsSize];
                in2.readIntArray(this.mSpanOffsets);
            }
            this.mSpanLookupSize = in2.readInt();
            if (this.mSpanLookupSize > 0) {
                this.mSpanLookup = new int[this.mSpanLookupSize];
                in2.readIntArray(this.mSpanLookup);
            }
            ...
            this.mLastLayoutRTL = in2.readInt() != 1 ? false : z2;
            this.mFullSpanItems = in2.readArrayList(LazySpanLookup.FullSpanItem.class.getClassLoader());
        }

...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        ...
        try {
            ...
            String drawableUri = "android.resource://" + this.mProviderContext.getPackageName() + IMemberProtocol.PARAM_SEPERATOR + resourceId;
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Uri.Builder uriBuilder = new Uri.Builder().scheme(ResponseBase.STRING_CONTENT).authority(authority).query("").fragment("");

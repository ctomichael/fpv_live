...
class AdapterHelper implements OpReorderer.Callback {
    ...
    static class UpdateOp {
        ...
        public String cmdToString() {
            switch (this.cmd) {
                case 1:
                    return ErrorPopModel.ACTION_ADD;
                case 2:
                    return "rm";
                case 3:
                case 5:
        ...
        public String toString() {
            return Integer.toHexString(System.identityHashCode(this)) + IMemberProtocol.STRING_SEPERATOR_LEFT + cmdToString() + ",s:" + this.positionStart + "c:" + this.itemCount + ",p:" + this.payload + IMemberProtocol.STRING_SEPERATOR_RIGHT;
        }

...
public final class JvmClassMappingKt {
    ...
    public static final <T> Class<T> getJavaPrimitiveType(@NotNull KClass<T> $this$javaPrimitiveType) {
        ...
        Class thisJClass2 = ((ClassBasedDeclarationContainer) $this$javaPrimitiveType).getJClass();
        if (!thisJClass2.isPrimitive()) {
            String name = thisJClass2.getName();
            if (name != null) {
                switch (name.hashCode()) {
                    case -2056817302:
                        if (name.equals("java.lang.Integer")) {
                            thisJClass = Integer.TYPE;
                            break;
                        }
                        break;
                    case -527879800:
                        if (name.equals("java.lang.Float")) {
                            thisJClass = Float.TYPE;
                            break;
                        }
                        break;
                    case -515992664:
                        if (name.equals("java.lang.Short")) {
                            thisJClass = Short.TYPE;
                            break;
                        }
                        break;
                    case 155276373:
                        if (name.equals("java.lang.Character")) {
                            thisJClass = Character.TYPE;
                            break;
                        }
                        break;
                    case 344809556:
                        if (name.equals("java.lang.Boolean")) {
                            thisJClass = Boolean.TYPE;
                            break;
                        }
                        break;
                    case 398507100:
                        if (name.equals("java.lang.Byte")) {
                            thisJClass = Byte.TYPE;
                            break;
                        }
                        break;
                    case 398795216:
                        if (name.equals("java.lang.Long")) {
                            thisJClass = Long.TYPE;
                            break;
                        }
                        break;
                    case 399092968:
                        if (name.equals("java.lang.Void")) {
                            thisJClass = Void.TYPE;
                            break;
                        }
                        break;
                    case 761287205:
                        if (name.equals("java.lang.Double")) {
                            thisJClass = Double.TYPE;
                            break;
                        }
                        break;
                }

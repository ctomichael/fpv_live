...
public enum CharCategory {
    ...
    public static final Lazy categoryMap$delegate = LazyKt.lazy(CharCategory$Companion$categoryMap$2.INSTANCE);
    @NotNull

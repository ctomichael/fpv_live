...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public BaseContinuationImpl(@Nullable Continuation<Object> completion2) {
        ...
        while (true) {
            ...
            try {
                ...
                if (outcome2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    outcome = Result.m3constructorimpl(outcome2);
                    $this$with.releaseIntercepted();
                    if (completion2 instanceof BaseContinuationImpl) {
                        current = (BaseContinuationImpl) completion2;
                        param = outcome;
                    } else {
                ...
                outcome = Result.m3constructorimpl(ResultKt.createFailure(exception));
            }
        }
    }

...
public abstract class ContinuationImpl extends BaseContinuationImpl {
    ...
    public ContinuationImpl(@Nullable Continuation<Object> completion, @Nullable CoroutineContext _context2) {
        super(completion);
    ...
    public final Continuation<Object> intercepted() {
        Continuation it2 = this.intercepted;
        if (it2 == null) {
            ContinuationInterceptor continuationInterceptor = (ContinuationInterceptor) getContext().get(ContinuationInterceptor.Key);
            if (continuationInterceptor == null || (it2 = continuationInterceptor.interceptContinuation(this)) == null) {
                it2 = this;
            }

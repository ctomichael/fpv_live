...
class SequenceBuilderKt__SequenceBuilderKt {
    ...
    public static final <T> Sequence<T> buildSequence(@NotNull @BuilderInference Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> builderAction) {
    ...
    @NotNull
    @SinceKotlin(version = "1.1")
    public static final <T> Iterator<T> buildIterator(@NotNull @BuilderInference Function2<? super SequenceBuilder<? super T>, ? super Continuation<? super Unit>, ? extends Object> builderAction) {
        Intrinsics.checkParameterIsNotNull(builderAction, "builderAction");

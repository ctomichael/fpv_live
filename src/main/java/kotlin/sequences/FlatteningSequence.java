...
public final class FlatteningSequence<T, R, E> implements Sequence<E> {
    ...
    public FlatteningSequence(@NotNull Sequence<? extends T> sequence2, @NotNull Function1<? super T, ? extends R> transformer2, @NotNull Function1<? super R, ? extends Iterator<? extends E>> iterator2) {
